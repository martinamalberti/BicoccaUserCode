...
process.alCaSuperClustersTest = cms.EDAnalyzer("AlCaSuperClustersTest",
  ...
  EE_SC_ES_corr = cms.InputTag ("correctedMulti5x5SuperClustersWithPreshower"),
  ES_SC_X       = cms.InputTag ("multi5x5SuperClustersWithPreshower:preshowerXClusters"),
  ES_SC_Y       = cms.InputTag ("multi5x5SuperClustersWithPreshower:preshowerYClusters"),
