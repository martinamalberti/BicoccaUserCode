...
void drawNoisePlots(TString InputFileName, TString suffix)
{
  ...
  g_RMSNoise_vsNvtx_EB -> GetXaxis() -> SetTitle("N_{vtx} or #LTN_{PU}#GT");
  ...
  legend -> AddEntry(g_RMSNoise_vsNavgPU_EB,"noise vs #LTN_{PU}#GT","P");
  legend -> Draw("same");
  
  TString NamePlot = Form("c1_RMSNoise_EB_%s.C",suffix.Data());
  c1_RMSNoise_EB -> SaveAs(NamePlot.Data(),"C");
  ...
  g_RMSNoise_vsNvtx_EE -> GetXaxis() -> SetTitle("N_{vtx} or #LTN_{PU}#GT");
  ...
  NamePlot = Form("c1_RMSNoise_EE_%s.C",suffix.Data());
  c1_RMSNoise_EE -> SaveAs(NamePlot.Data(),"C");
  ...
  NamePlot = Form("c1_noiseAtZero_vsIeta_EB_%s.C",suffix.Data());
  c1_noiseAtZero_vsIeta_EB -> SaveAs(NamePlot.Data(),"C");
  ...
  NamePlot = Form("c1_noiseSlope_vsIeta_EB_%s.C",suffix.Data());
  c1_noiseSlope_vsIeta_EB -> SaveAs(NamePlot.Data(),"C");
  ...
  NamePlot = Form("c1_addNoise_vsIeta_EB_%s.C",suffix.Data());
  c1_addNoise_vsIeta_EB -> SaveAs(NamePlot.Data(),".C");
  ...
  NamePlot = Form("c1_noiseAtZero_vsIring_EE_%s.C",suffix.Data());
  c1_noiseAtZero_vsIring_EE -> SaveAs(NamePlot.Data(),"C"); 
  ...
  NamePlot = Form("c1_noiseSlope_vsIring_EE _%s.C",suffix.Data());
  c1_noiseSlope_vsIring_EE  -> SaveAs(NamePlot.Data(),"C");
  ...
  NamePlot = Form("c1_addNoise_vsIring_EE_%s.C",suffix.Data());
  c1_addNoise_vsIring_EE-> SaveAs(NamePlot.Data(),"C");
}
