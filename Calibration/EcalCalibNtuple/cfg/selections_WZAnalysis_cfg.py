...
process.Input = cms.PSet(
    ...
    #inputFileList = cms.string("cfg/list_EGElectron_Run2010AB-Apr21ReReco-v1.txt"),
    #inputFileList = cms.string("cfg/list_SingleElectron_Run2011A-May10ReReco-v1_160329-163869.txt"),
    inputFileList = cms.string("cfg/list_SingleElectron_Run2011A-PromptReco-v4_165071-165980.txt"),
...
process.Output = cms.PSet(
    outputRootFilePath = cms.string("/data1/abenagli/NTUPLES/CALIBRATION/Run2011A/WZAnalysis/"),
