...
process.Input = cms.PSet(
    ...
    inputFileList = cms.string("/afs/cern.ch/user/r/rgerosa/scratch0/CMSSW_4_2_8_patch3/src/Calibration/EcalCalibNtuple/cfg/list.txt"),
...
process.Output = cms.PSet(
    outputRootFilePath = cms.string("/data2/"),
    outputRootFileName = cms.string("WZAnalysi_Test2012B")
    )
