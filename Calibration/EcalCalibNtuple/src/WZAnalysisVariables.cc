...
void InitializeWZAnalysisTree(WZAnalysisVariables& vars, const std::string& outputRootFileName, bool isCalib)
{
  ...
  vars.m_reducedTree -> Branch("ele1_scE_forZS",            &vars.ele1_scE_forZS,                       "ele1_scE_forZS/F");
  ...
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bEMax_Over_bCE", &vars.ele1_eRegrInput_bEMax_Over_bCE,
"ele1_eRegrInput_bEMax_Over_bCE/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bE2nd_Over_bEMax", &vars.ele1_eRegrInput_log_bE2nd_Over_bEMax, "ele1_eRegrInput_log_bE2nd_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEtop_Over_bEMax", &vars.ele1_eRegrInput_log_bEtop_Over_bEMax, "ele1_eRegrInput_log_bEtop_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEbot_Over_bEMax", &vars.ele1_eRegrInput_log_bEbot_Over_bEMax, "ele1_eRegrInput_log_bEbot_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEleft_Over_bEMax", &vars.ele1_eRegrInput_log_bEleft_Over_bEMax, "ele1_eRegrInput_log_bEleft_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEright_Over_bEMax", &vars.ele1_eRegrInput_log_bEright_Over_bEMax, "ele1_eRegrInput_log_bEright_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_asym_top_bottom", &vars.ele1_eRegrInput_asym_top_bottom, "ele1_eRegrInput_asym_top_bottom/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_asym_left_right", &vars.ele1_eRegrInput_asym_left_right, "ele1_eRegrInput_asym_left_right/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_Deta_bC2_sC", &vars.ele1_eRegrInput_Deta_bC2_sC, "ele1_eRegrInput_Deta_bC2_sC/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_Dphi_bC2_sC", &vars.ele1_eRegrInput_Dphi_bC2_sC, "ele1_eRegrInput_Dphi_bC2_sC/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bCE2_Over_sCE", &vars.ele1_eRegrInput_bCE2_Over_sCE, "ele1_eRegrInput_bCE2_Over_sCE/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e3x3_Over_bCE2", &vars.ele1_eRegrInput_e3x3_Over_bCE2, "ele1_eRegrInput_e3x3_Over_bCE2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e5x5_Over_bCE2", &vars.ele1_eRegrInput_e5x5_Over_bCE2, "ele1_eRegrInput_e5x5_Over_bCE2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaieta_bC2", &vars.ele1_eRegrInput_sigietaieta_bC2, "ele1_eRegrInput_sigietaieta_bC2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigiphiiphi_bC2", &vars.ele1_eRegrInput_sigiphiiphi_bC2, "ele1_eRegrInput_sigiphiiphi_bC2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaiphi_bC2", &vars.ele1_eRegrInput_sigietaiphi_bC2, "ele1_eRegrInput_sigietaiphi_bC2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bEMax_Over_bCE2", &vars.ele1_eRegrInput_bEMax_Over_bCE2, "ele1_eRegrInput_bEMax_Over_bCE2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bE2nd_Over_bEMax2", &vars.ele1_eRegrInput_log_bE2nd_Over_bEMax2, "ele1_eRegrInput_log_bE2nd_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEtop_Over_bEMax2", &vars.ele1_eRegrInput_log_bEtop_Over_bEMax2, "ele1_eRegrInput_log_bEtop_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEbot_Over_bEMax2", &vars.ele1_eRegrInput_log_bEbot_Over_bEMax2, "ele1_eRegrInput_log_bEbot_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEleft_Over_bEMax2", &vars.ele1_eRegrInput_log_bEleft_Over_bEMax2, "ele1_eRegrInput_log_bEleft_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_log_bEright_Over_bEMax2", &vars.ele1_eRegrInput_log_bEright_Over_bEMax2, "ele1_eRegrInput_log_bEright_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_asym_top2_bottom2", &vars.ele1_eRegrInput_asym_top2_bottom2, "ele1_eRegrInput_asym_top2_bottom2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_asym_left2_right2", &vars.ele1_eRegrInput_asym_left2_right2, "ele1_eRegrInput_asym_left2_right2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_Deta_bCLow_sC", &vars.ele1_eRegrInput_Deta_bCLow_sC, "ele1_eRegrInput_Deta_bCLow_sC/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_Dphi_bCLow_sC", &vars.ele1_eRegrInput_Dphi_bCLow_sC, "ele1_eRegrInput_Dphi_bCLow_sC/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bCELow_Over_sCE", &vars.ele1_eRegrInput_bCELow_Over_sCE, "ele1_eRegrInput_bCELow_Over_sCE/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e3x3_Over_bCELow", &vars.ele1_eRegrInput_e3x3_Over_bCELow, "ele1_eRegrInput_e3x3_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e5x5_Over_bCELow", &vars.ele1_eRegrInput_e5x5_Over_bCELow, "ele1_eRegrInput_e5x5_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaieta_bCLow", &vars.ele1_eRegrInput_sigietaieta_bCLow, "ele1_eRegrInput_sigietaieta_bCLow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e5x5_Over_bCELow", &vars.ele1_eRegrInput_e5x5_Over_bCELow, "ele1_eRegrInput_e5x5_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaieta_bCLow", &vars.ele1_eRegrInput_sigietaieta_bCLow, "ele1_eRegrInput_sigietaieta_bCLow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigiphiiphi_bCLow", &vars.ele1_eRegrInput_sigiphiiphi_bCLow, "ele1_eRegrInput_e5x5_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaiphi_bCLow", &vars.ele1_eRegrInput_sigietaiphi_bCLow, "ele1_eRegrInput_sigietaiphi_bCLow/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_Deta_bCLow2_sC", &vars.ele1_eRegrInput_Deta_bCLow2_sC, "ele1_eRegrInput_Deta_bCLow2_sC/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_Dphi_bCLow2_sC", &vars.ele1_eRegrInput_Dphi_bCLow2_sC, "ele1_eRegrInput_Dphi_bCLow2_sC/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bCELow2_Over_sCE", &vars.ele1_eRegrInput_bCELow2_Over_sCE, "ele1_eRegrInput_bCELow2_Over_sCE/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e3x3_Over_bCELow2", &vars.ele1_eRegrInput_e3x3_Over_bCELow2, "ele1_eRegrInput_e3x3_Over_bCELow2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_e5x5_Over_bCELow2", &vars.ele1_eRegrInput_e5x5_Over_bCELow2, "ele1_eRegrInput_e5x5_Over_bCELow2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaieta_bCLow2", &vars.ele1_eRegrInput_sigietaieta_bCLow2, "ele1_eRegrInput_sigietaieta_bCLow2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigiphiiphi_bCLow2", &vars.ele1_eRegrInput_sigiphiiphi_bCLow2, "ele1_eRegrInput_sigiphiiphi_bCLow2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_sigietaiphi_bCLow2", &vars.ele1_eRegrInput_sigietaiphi_bCLow2, "ele1_eRegrInput_sigietaiphi_bCLow2/F");
  ...
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_eta", &vars.ele1_eRegrInput_bC2_eta, "ele1_eRegrInput_bC2_eta/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_phi", &vars.ele1_eRegrInput_bC2_phi, "ele1_eRegrInput_bC2_phi/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_eta_p5", &vars.ele1_eRegrInput_bC2_eta_p5, "ele1_eRegrInput_bC2_eta_p5/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_phi_p2", &vars.ele1_eRegrInput_bC2_phi_p2, "ele1_eRegrInput_bC2_phi_p2/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_bieta", &vars.ele1_eRegrInput_bC2_bieta, "ele1_eRegrInput_bC2_bieta/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_phi_p20", &vars.ele1_eRegrInput_bC2_phi_p20, "ele1_eRegrInput_bC2_phi_p20/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_etacry", &vars.ele1_eRegrInput_bC2_etacry, "ele1_eRegrInput_bC2_etacry/F");
  vars.m_reducedTree -> Branch("ele1_eRegrInput_bC2_phicry", &vars.ele1_eRegrInput_bC2_phicry, "ele1_eRegrInput_bC2_phicry/F");
  ...
  vars.m_reducedTree -> Branch("ele2_scE_forZS",            &vars.ele2_scE_forZS,                       "ele2_scE_forZS/F");
  ...
  vars.m_reducedTree -> Branch("ele2_eRegrInput_etaW", &vars.ele2_eRegrInput_etaW, "ele2_eRegrInput_etaW/F");
  ...
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bEMax_Over_bCE", &vars.ele2_eRegrInput_bEMax_Over_bCE,
"ele2_eRegrInput_bEMax_Over_bCE/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bE2nd_Over_bEMax", &vars.ele2_eRegrInput_log_bE2nd_Over_bEMax, "ele2_eRegrInput_log_bE2nd_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEtop_Over_bEMax", &vars.ele2_eRegrInput_log_bEtop_Over_bEMax, "ele2_eRegrInput_log_bEtop_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEbot_Over_bEMax", &vars.ele2_eRegrInput_log_bEbot_Over_bEMax, "ele2_eRegrInput_log_bEbot_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEleft_Over_bEMax", &vars.ele2_eRegrInput_log_bEleft_Over_bEMax, "ele2_eRegrInput_log_bEleft_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEright_Over_bEMax", &vars.ele2_eRegrInput_log_bEright_Over_bEMax, "ele2_eRegrInput_log_bEright_Over_bEMax/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_asym_top_bottom", &vars.ele2_eRegrInput_asym_top_bottom, "ele2_eRegrInput_asym_top_bottom/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_asym_left_right", &vars.ele2_eRegrInput_asym_left_right, "ele2_eRegrInput_asym_left_right/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_Deta_bC2_sC", &vars.ele2_eRegrInput_Deta_bC2_sC, "ele2_eRegrInput_Deta_bC2_sC/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_Dphi_bC2_sC", &vars.ele2_eRegrInput_Dphi_bC2_sC, "ele2_eRegrInput_Dphi_bC2_sC/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bCE2_Over_sCE", &vars.ele2_eRegrInput_bCE2_Over_sCE, "ele2_eRegrInput_bCE2_Over_sCE/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e3x3_Over_bCE2", &vars.ele2_eRegrInput_e3x3_Over_bCE2, "ele2_eRegrInput_e3x3_Over_bCE2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e5x5_Over_bCE2", &vars.ele2_eRegrInput_e5x5_Over_bCE2, "ele2_eRegrInput_e5x5_Over_bCE2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaieta_bC2", &vars.ele2_eRegrInput_sigietaieta_bC2, "ele2_eRegrInput_sigietaieta_bC2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigiphiiphi_bC2", &vars.ele2_eRegrInput_sigiphiiphi_bC2, "ele2_eRegrInput_sigiphiiphi_bC2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaiphi_bC2", &vars.ele2_eRegrInput_sigietaiphi_bC2, "ele2_eRegrInput_sigietaiphi_bC2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bEMax_Over_bCE2", &vars.ele2_eRegrInput_bEMax_Over_bCE2, "ele2_eRegrInput_bEMax_Over_bCE2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bE2nd_Over_bEMax2", &vars.ele2_eRegrInput_log_bE2nd_Over_bEMax2, "ele2_eRegrInput_log_bE2nd_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEtop_Over_bEMax2", &vars.ele2_eRegrInput_log_bEtop_Over_bEMax2, "ele2_eRegrInput_log_bEtop_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEbot_Over_bEMax2", &vars.ele2_eRegrInput_log_bEbot_Over_bEMax2, "ele2_eRegrInput_log_bEbot_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEleft_Over_bEMax2", &vars.ele2_eRegrInput_log_bEleft_Over_bEMax2, "ele2_eRegrInput_log_bEleft_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_log_bEright_Over_bEMax2", &vars.ele2_eRegrInput_log_bEright_Over_bEMax2, "ele2_eRegrInput_log_bEright_Over_bEMax2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_asym_top2_bottom2", &vars.ele2_eRegrInput_asym_top2_bottom2, "ele2_eRegrInput_asym_top2_bottom2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_asym_left2_right2", &vars.ele2_eRegrInput_asym_left2_right2, "ele2_eRegrInput_asym_left2_right2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_Deta_bCLow_sC", &vars.ele2_eRegrInput_Deta_bCLow_sC, "ele2_eRegrInput_Deta_bCLow_sC/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_Dphi_bCLow_sC", &vars.ele2_eRegrInput_Dphi_bCLow_sC, "ele2_eRegrInput_Dphi_bCLow_sC/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bCELow_Over_sCE", &vars.ele2_eRegrInput_bCELow_Over_sCE, "ele2_eRegrInput_bCELow_Over_sCE/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e3x3_Over_bCELow", &vars.ele2_eRegrInput_e3x3_Over_bCELow, "ele2_eRegrInput_e3x3_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e5x5_Over_bCELow", &vars.ele2_eRegrInput_e5x5_Over_bCELow, "ele2_eRegrInput_e5x5_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaieta_bCLow", &vars.ele2_eRegrInput_sigietaieta_bCLow, "ele2_eRegrInput_sigietaieta_bCLow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e5x5_Over_bCELow", &vars.ele2_eRegrInput_e5x5_Over_bCELow, "ele2_eRegrInput_e5x5_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaieta_bCLow", &vars.ele2_eRegrInput_sigietaieta_bCLow, "ele2_eRegrInput_sigietaieta_bCLow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigiphiiphi_bCLow", &vars.ele2_eRegrInput_sigiphiiphi_bCLow, "ele2_eRegrInput_e5x5_Over_bCELow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaiphi_bCLow", &vars.ele2_eRegrInput_sigietaiphi_bCLow, "ele2_eRegrInput_sigietaiphi_bCLow/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_Deta_bCLow2_sC", &vars.ele2_eRegrInput_Deta_bCLow2_sC, "ele2_eRegrInput_Deta_bCLow2_sC/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_Dphi_bCLow2_sC", &vars.ele2_eRegrInput_Dphi_bCLow2_sC, "ele2_eRegrInput_Dphi_bCLow2_sC/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bCELow2_Over_sCE", &vars.ele2_eRegrInput_bCELow2_Over_sCE, "ele2_eRegrInput_bCELow2_Over_sCE/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e3x3_Over_bCELow2", &vars.ele2_eRegrInput_e3x3_Over_bCELow2, "ele2_eRegrInput_e3x3_Over_bCELow2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_e5x5_Over_bCELow2", &vars.ele2_eRegrInput_e5x5_Over_bCELow2, "ele2_eRegrInput_e5x5_Over_bCELow2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaieta_bCLow2", &vars.ele2_eRegrInput_sigietaieta_bCLow2, "ele2_eRegrInput_sigietaieta_bCLow2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigiphiiphi_bCLow2", &vars.ele2_eRegrInput_sigiphiiphi_bCLow2, "ele2_eRegrInput_sigiphiiphi_bCLow2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_sigietaiphi_bCLow2", &vars.ele2_eRegrInput_sigietaiphi_bCLow2, "ele2_eRegrInput_sigietaiphi_bCLow2/F");
  ...
  vars.m_reducedTree -> Branch("ele2_eRegrInput_seedbC_bieta", &vars.ele2_eRegrInput_seedbC_bieta, "ele2_eRegrInput_seedbC_bieta/F");
  ...
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_eta", &vars.ele2_eRegrInput_bC2_eta, "ele2_eRegrInput_bC2_eta/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_phi", &vars.ele2_eRegrInput_bC2_phi, "ele2_eRegrInput_bC2_phi/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_eta_p5", &vars.ele2_eRegrInput_bC2_eta_p5, "ele2_eRegrInput_bC2_eta_p5/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_phi_p2", &vars.ele2_eRegrInput_bC2_phi_p2, "ele2_eRegrInput_bC2_phi_p2/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_bieta", &vars.ele2_eRegrInput_bC2_bieta, "ele2_eRegrInput_bC2_bieta/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_phi_p20", &vars.ele2_eRegrInput_bC2_phi_p20, "ele2_eRegrInput_bC2_phi_p20/F");
  vars.m_reducedTree -> Branch("ele2_eRegrInput_bC2_etacry", &vars.ele2_eRegrInput_bC2_etacry, "ele2_eRegrInput_bC2_etacry/F");
 ...
 vars.m_reducedTree -> Branch("ele1ele2_scMZS", &vars.ele1ele2_scMZS, "ele1ele2_scMZS/F");
...
void ClearWZAnalysisVariables(WZAnalysisVariables& vars, bool isCalib)
{
  ...
  // regression ele1 variables

  vars.ele1_eRegrInput_rawE = -99.;
  vars.ele1_eRegrInput_r9 = -99.;
  vars.ele1_eRegrInput_eta = -99. ;
  vars.ele1_eRegrInput_phi = -99.;
  vars.ele1_eRegrInput_r25= -99.;
  vars.ele1_eRegrInput_hoe= -99.;
  vars.ele1_eRegrInput_etaW= -99.;
  vars.ele1_eRegrInput_phiW= -99.;

  vars.ele1_eRegrInput_Deta_bC_sC= -99.;
  vars.ele1_eRegrInput_Dphi_bC_sC= -99.;
  vars.ele1_eRegrInput_bCE_Over_sCE= -99.;
  vars.ele1_eRegrInput_e3x3_Over_bCE= -99.;
  vars.ele1_eRegrInput_e5x5_Over_bCE= -99.;
  vars.ele1_eRegrInput_sigietaieta_bC1= -99.;
  vars.ele1_eRegrInput_sigiphiiphi_bC1= -99.;
  vars.ele1_eRegrInput_sigietaiphi_bC1= -99.;
  vars.ele1_eRegrInput_bEMax_Over_bCE= -99.;
  vars.ele1_eRegrInput_log_bE2nd_Over_bEMax= -99.;
  vars.ele1_eRegrInput_log_bEtop_Over_bEMax= -99.;
  vars.ele1_eRegrInput_log_bEbot_Over_bEMax= -99.;
  vars.ele1_eRegrInput_log_bEleft_Over_bEMax= -99.;
  vars.ele1_eRegrInput_log_bEright_Over_bEMax= -99.;
  vars.ele1_eRegrInput_asym_top_bottom= -99.;
  vars.ele1_eRegrInput_asym_left_right= -99.;
  vars.ele1_eRegrInput_Deta_bC2_sC= -99.;
  vars.ele1_eRegrInput_Dphi_bC2_sC= -99.;
  vars.ele1_eRegrInput_bCE2_Over_sCE= -99.;
  vars.ele1_eRegrInput_e3x3_Over_bCE2= -99.;
  vars.ele1_eRegrInput_e5x5_Over_bCE2= -99.;
  vars.ele1_eRegrInput_sigietaieta_bC2= -99.;
  vars.ele1_eRegrInput_sigiphiiphi_bC2= -99.;
  vars.ele1_eRegrInput_sigietaiphi_bC2= -99.;
  vars.ele1_eRegrInput_bEMax_Over_bCE2= -99.;
  vars.ele1_eRegrInput_log_bE2nd_Over_bEMax2= -99.;
  vars.ele1_eRegrInput_log_bEtop_Over_bEMax2= -99.;
  vars.ele1_eRegrInput_log_bEbot_Over_bEMax2= -99.;
  vars.ele1_eRegrInput_log_bEleft_Over_bEMax2= -99.;
  vars.ele1_eRegrInput_log_bEright_Over_bEMax2= -99.;
  vars.ele1_eRegrInput_asym_top2_bottom2= -99.;
  vars.ele1_eRegrInput_asym_left2_right2= -99.;
  vars.ele1_eRegrInput_Deta_bCLow_sC= -99.;
  vars.ele1_eRegrInput_Dphi_bCLow_sC= -99.;
  vars.ele1_eRegrInput_bCELow_Over_sCE= -99.;
  vars.ele1_eRegrInput_e3x3_Over_bCELow= -99.;
  vars.ele1_eRegrInput_e5x5_Over_bCELow= -99.;
  vars.ele1_eRegrInput_sigietaieta_bCLow= -99.;
  vars.ele1_eRegrInput_sigiphiiphi_bCLow= -99.;
  vars.ele1_eRegrInput_sigietaiphi_bCLow= -99.;
  vars.ele1_eRegrInput_Deta_bCLow2_sC= -99.;
  vars.ele1_eRegrInput_Dphi_bCLow2_sC= -99.;
  vars.ele1_eRegrInput_bCELow2_Over_sCE= -99.;
  vars.ele1_eRegrInput_e3x3_Over_bCELow2= -99.;
  vars.ele1_eRegrInput_e5x5_Over_bCELow2= -99.;
  vars.ele1_eRegrInput_sigietaieta_bCLow2= -99.;
  vars.ele1_eRegrInput_sigiphiiphi_bCLow2= -99.;
  vars.ele1_eRegrInput_sigietaiphi_bCLow2= -99.;
  vars.ele1_eRegrInput_seedbC_eta= -99.;
  vars.ele1_eRegrInput_seedbC_phi= -99.;
  vars.ele1_eRegrInput_seedbC_eta_p5= -99.;
  vars.ele1_eRegrInput_seedbC_phi_p2= -99.;
  vars.ele1_eRegrInput_seedbC_bieta= -99.;
  vars.ele1_eRegrInput_seedbC_phi_p20= -99.;
  vars.ele1_eRegrInput_seedbC_etacry= -99.;
  vars.ele1_eRegrInput_seedbC_phicry= -99.;
  vars.ele1_eRegrInput_bC2_eta= -99.;
  vars.ele1_eRegrInput_bC2_phi= -99.;
  vars.ele1_eRegrInput_bC2_eta_p5= -99.;
  vars.ele1_eRegrInput_bC2_phi_p2= -99.;
  vars.ele1_eRegrInput_bC2_bieta= -99.;
  vars.ele1_eRegrInput_bC2_phi_p20= -99.;
  vars.ele1_eRegrInput_bC2_etacry= -99.;
  vars.ele1_eRegrInput_bC2_phicry= -99.;
  vars.ele1_eRegrInput_nPV= -99.;
  ...
  // regression varables
  vars.ele2_eRegrInput_rawE = -99.;
  vars.ele2_eRegrInput_r9 = -99.;
  vars.ele2_eRegrInput_eta = -99. ;
  vars.ele2_eRegrInput_phi = -99.;
  vars.ele2_eRegrInput_r25= -99.;
  vars.ele2_eRegrInput_hoe= -99.;
  vars.ele2_eRegrInput_etaW= -99.;
  vars.ele2_eRegrInput_phiW= -99.;

  vars.ele2_eRegrInput_Deta_bC_sC= -99.;
  vars.ele2_eRegrInput_Dphi_bC_sC= -99.;
  vars.ele2_eRegrInput_bCE_Over_sCE= -99.;
  vars.ele2_eRegrInput_e3x3_Over_bCE= -99.;
  vars.ele2_eRegrInput_e5x5_Over_bCE= -99.;
  vars.ele2_eRegrInput_sigietaieta_bC1= -99.;
  vars.ele2_eRegrInput_sigiphiiphi_bC1= -99.;
  vars.ele2_eRegrInput_sigietaiphi_bC1= -99.;
  vars.ele2_eRegrInput_bEMax_Over_bCE= -99.;
  vars.ele2_eRegrInput_log_bE2nd_Over_bEMax= -99.;
  vars.ele2_eRegrInput_log_bEtop_Over_bEMax= -99.;
  vars.ele2_eRegrInput_log_bEbot_Over_bEMax= -99.;
  vars.ele2_eRegrInput_log_bEleft_Over_bEMax= -99.;
  vars.ele2_eRegrInput_log_bEright_Over_bEMax= -99.;
  vars.ele2_eRegrInput_asym_top_bottom= -99.;
  vars.ele2_eRegrInput_asym_left_right= -99.;
  vars.ele2_eRegrInput_Deta_bC2_sC= -99.;
  vars.ele2_eRegrInput_Dphi_bC2_sC= -99.;
  vars.ele2_eRegrInput_bCE2_Over_sCE= -99.;
  vars.ele2_eRegrInput_e3x3_Over_bCE2= -99.;
  vars.ele2_eRegrInput_e5x5_Over_bCE2= -99.;
  vars.ele2_eRegrInput_sigietaieta_bC2= -99.;
  vars.ele2_eRegrInput_sigiphiiphi_bC2= -99.;
  vars.ele2_eRegrInput_sigietaiphi_bC2= -99.;
  vars.ele2_eRegrInput_bEMax_Over_bCE2= -99.;
  vars.ele2_eRegrInput_log_bE2nd_Over_bEMax2= -99.;
  vars.ele2_eRegrInput_log_bEtop_Over_bEMax2= -99.;
  vars.ele2_eRegrInput_log_bEbot_Over_bEMax2= -99.;
  vars.ele2_eRegrInput_log_bEleft_Over_bEMax2= -99.;
  vars.ele2_eRegrInput_log_bEright_Over_bEMax2= -99.;
  vars.ele2_eRegrInput_asym_top2_bottom2= -99.;
  vars.ele2_eRegrInput_asym_left2_right2= -99.;
  vars.ele2_eRegrInput_Deta_bCLow_sC= -99.;
  vars.ele2_eRegrInput_Dphi_bCLow_sC= -99.;
  vars.ele2_eRegrInput_bCELow_Over_sCE= -99.;
  vars.ele2_eRegrInput_e3x3_Over_bCELow= -99.;
  vars.ele2_eRegrInput_e5x5_Over_bCELow= -99.;
  vars.ele2_eRegrInput_sigietaieta_bCLow= -99.;
  vars.ele2_eRegrInput_sigiphiiphi_bCLow= -99.;
  vars.ele2_eRegrInput_sigietaiphi_bCLow= -99.;
  vars.ele2_eRegrInput_Deta_bCLow2_sC= -99.;
  vars.ele2_eRegrInput_Dphi_bCLow2_sC= -99.;
  vars.ele2_eRegrInput_bCELow2_Over_sCE= -99.;
  vars.ele2_eRegrInput_e3x3_Over_bCELow2= -99.;
  vars.ele2_eRegrInput_e5x5_Over_bCELow2= -99.;
  vars.ele2_eRegrInput_sigietaieta_bCLow2= -99.;
  vars.ele2_eRegrInput_sigiphiiphi_bCLow2= -99.;
  vars.ele2_eRegrInput_sigietaiphi_bCLow2= -99.;
  vars.ele2_eRegrInput_seedbC_eta= -99.;
  vars.ele2_eRegrInput_seedbC_phi= -99.;
  vars.ele2_eRegrInput_seedbC_eta_p5= -99.;
  vars.ele2_eRegrInput_seedbC_phi_p2= -99.;
  vars.ele2_eRegrInput_seedbC_bieta= -99.;
  vars.ele2_eRegrInput_seedbC_phi_p20= -99.;
  vars.ele2_eRegrInput_seedbC_etacry= -99.;
  vars.ele2_eRegrInput_seedbC_phicry= -99.;
  vars.ele2_eRegrInput_bC2_eta= -99.;
  vars.ele2_eRegrInput_bC2_phi= -99.;
  vars.ele2_eRegrInput_bC2_eta_p5= -99.;
  vars.ele2_eRegrInput_bC2_phi_p2= -99.;
  vars.ele2_eRegrInput_bC2_bieta= -99.;
  vars.ele2_eRegrInput_bC2_phi_p20= -99.;
  vars.ele2_eRegrInput_bC2_etacry= -99.;
  vars.ele2_eRegrInput_bC2_phicry= -99.;
  vars.ele2_eRegrInput_nPV= -99.;
...
{  
  ...
  if(isCalib)
  {
   ...
   for ( int iRecHit = theRecHitBeginIndex; iRecHit < theRecHitBeginIndex + reader.GetInt("recHit_n")->at(ele1It); iRecHit++ ){
    ...
    if(reader.GetFloat("recHit_E")->at(iRecHit)>0.095) vars.ele1_scE_forZS=vars.ele1_scE_forZS+reader.GetFloat("recHit_E")->at(iRecHit);
  ...
  vars.ele1_eRegrInput_log_bE2nd_Over_bEMax= reader.GetFloat("eRegrInput_log_bE2nd_Over_bEMax")->at(ele1It);
  vars.ele1_eRegrInput_log_bEtop_Over_bEMax= reader.GetFloat("eRegrInput_log_bEtop_Over_bEMax")->at(ele1It);
  vars.ele1_eRegrInput_log_bEbot_Over_bEMax= reader.GetFloat("eRegrInput_log_bEbot_Over_bEMax")->at(ele1It);
  vars.ele1_eRegrInput_log_bEleft_Over_bEMax= reader.GetFloat("eRegrInput_log_bEleft_Over_bEMax")->at(ele1It);
  vars.ele1_eRegrInput_log_bEright_Over_bEMax= reader.GetFloat("eRegrInput_log_bEright_Over_bEMax")->at(ele1It);
  vars.ele1_eRegrInput_asym_top_bottom= reader.GetFloat("eRegrInput_asym_top_bottom")->at(ele1It);
  vars.ele1_eRegrInput_asym_left_right= reader.GetFloat("eRegrInput_asym_left_right")->at(ele1It);
  vars.ele1_eRegrInput_Deta_bC2_sC= reader.GetFloat("eRegrInput_Deta_bC2_sC")->at(ele1It);
  vars.ele1_eRegrInput_Dphi_bC2_sC= reader.GetFloat("eRegrInput_Dphi_bC2_sC")->at(ele1It);
  vars.ele1_eRegrInput_bCE2_Over_sCE= reader.GetFloat("eRegrInput_bCE2_Over_sCE")->at(ele1It);
  vars.ele1_eRegrInput_e3x3_Over_bCE2= reader.GetFloat("eRegrInput_e3x3_Over_bCE2")->at(ele1It);
  vars.ele1_eRegrInput_e5x5_Over_bCE2= reader.GetFloat("eRegrInput_e5x5_Over_bCE2")->at(ele1It);
  
  vars.ele1_eRegrInput_sigietaieta_bC2= reader.GetFloat("eRegrInput_sigietaieta_bC2")->at(ele1It);
  vars.ele1_eRegrInput_sigiphiiphi_bC2= reader.GetFloat("eRegrInput_sigiphiiphi_bC2")->at(ele1It);
  vars.ele1_eRegrInput_sigietaiphi_bC2= reader.GetFloat("eRegrInput_sigietaiphi_bC2")->at(ele1It);
  vars.ele1_eRegrInput_bEMax_Over_bCE2= reader.GetFloat("eRegrInput_bEMax_Over_bCE2")->at(ele1It);
  vars.ele1_eRegrInput_log_bE2nd_Over_bEMax2= reader.GetFloat("eRegrInput_log_bE2nd_Over_bEMax2")->at(ele1It);
  vars.ele1_eRegrInput_log_bEtop_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEtop_Over_bEMax2")->at(ele1It);
  vars.ele1_eRegrInput_log_bEbot_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEbot_Over_bEMax2")->at(ele1It);
  vars.ele1_eRegrInput_log_bEleft_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEleft_Over_bEMax2")->at(ele1It);
  vars.ele1_eRegrInput_log_bEright_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEright_Over_bEMax2")->at(ele1It);
  vars.ele1_eRegrInput_asym_top2_bottom2= reader.GetFloat("eRegrInput_asym_top2_bottom2")->at(ele1It);
  vars.ele1_eRegrInput_asym_left2_right2= reader.GetFloat("eRegrInput_asym_left2_right2")->at(ele1It);
  
  vars.ele1_eRegrInput_Deta_bCLow_sC= reader.GetFloat("eRegrInput_Deta_bCLow_sC")->at(ele1It);
  vars.ele1_eRegrInput_Dphi_bCLow_sC= reader.GetFloat("eRegrInput_Dphi_bCLow_sC")->at(ele1It);
  vars.ele1_eRegrInput_bCELow_Over_sCE= reader.GetFloat("eRegrInput_bCELow_Over_sCE")->at(ele1It);
  vars.ele1_eRegrInput_e3x3_Over_bCELow= reader.GetFloat("eRegrInput_e3x3_Over_bCELow")->at(ele1It);
  vars.ele1_eRegrInput_e5x5_Over_bCELow= reader.GetFloat("eRegrInput_e5x5_Over_bCELow")->at(ele1It);
  vars.ele1_eRegrInput_sigietaieta_bCLow= reader.GetFloat("eRegrInput_sigietaieta_bCLow")->at(ele1It);
  vars.ele1_eRegrInput_sigiphiiphi_bCLow= reader.GetFloat("eRegrInput_sigiphiiphi_bCLow")->at(ele1It);
 
  vars.ele1_eRegrInput_sigietaiphi_bCLow= reader.GetFloat("eRegrInput_sigiphiiphi_bCLow")->at(ele1It);
  vars.ele1_eRegrInput_Deta_bCLow2_sC= reader.GetFloat("eRegrInput_Deta_bCLow2_sC")->at(ele1It);
  vars.ele1_eRegrInput_Dphi_bCLow2_sC= reader.GetFloat("eRegrInput_Dphi_bCLow2_sC")->at(ele1It);
  vars.ele1_eRegrInput_bCELow2_Over_sCE= reader.GetFloat("eRegrInput_bCELow2_Over_sCE")->at(ele1It);
  vars.ele1_eRegrInput_e3x3_Over_bCELow2= reader.GetFloat("eRegrInput_e3x3_Over_bCELow2")->at(ele1It);
  vars.ele1_eRegrInput_e5x5_Over_bCELow2= reader.GetFloat("eRegrInput_e5x5_Over_bCELow2")->at(ele1It);
  vars.ele1_eRegrInput_sigietaieta_bCLow2= reader.GetFloat("eRegrInput_sigietaieta_bCLow2")->at(ele1It);
  vars.ele1_eRegrInput_sigiphiiphi_bCLow2= reader.GetFloat("eRegrInput_sigiphiiphi_bCLow2")->at(ele1It);
  vars.ele1_eRegrInput_sigietaiphi_bCLow2= reader.GetFloat("eRegrInput_sigietaiphi_bCLow2")->at(ele1It);
  ...
  vars.ele1_eRegrInput_bC2_eta= reader.GetFloat("eRegrInput_bC2_eta")->at(ele1It);
  vars.ele1_eRegrInput_bC2_phi= reader.GetFloat("eRegrInput_bC2_phi")->at(ele1It);
  vars.ele1_eRegrInput_bC2_eta_p5= reader.GetFloat("eRegrInput_bC2_eta_p5")->at(ele1It);
  vars.ele1_eRegrInput_bC2_phi_p2= reader.GetFloat("eRegrInput_bC2_phi_p2")->at(ele1It);
  vars.ele1_eRegrInput_bC2_bieta= reader.GetFloat("eRegrInput_bC2_bieta")->at(ele1It);
...
void SetElectron2Variables(WZAnalysisVariables& vars, treeReader& reader, const int& ele2It, bool isCalib)
{
  ...
  for ( int iRecHit = theRecHitBeginIndex; iRecHit < theRecHitBeginIndex + reader.GetInt("recHit_n")->at(ele2It); iRecHit++ ){
    ...
    int iRecHit_zside = reader.GetInt("recHit_zside")->at(iRecHit);
    float iRecHit_E = reader.GetFloat("recHit_E")->at(iRecHit);
    if(reader.GetFloat("recHit_E")->at(iRecHit)>0.095) vars.ele2_scE_forZS=vars.ele2_scE_forZS+reader.GetFloat("recHit_E")->at(iRecHit);
    int iRecHit_hashedIndex = reader.GetInt("recHit_hashedIndex")->at(iRecHit);
    int iRecHit_flag = reader.GetInt("recHit_flag")->at(iRecHit);
    int iRecHit_ietaORix, iRecHit_iphiORiy;
    if ( iRecHit_zside == 0 ) {
 ...
 vars.ele2_eRegrInput_log_bE2nd_Over_bEMax= reader.GetFloat("eRegrInput_log_bE2nd_Over_bEMax")->at(ele2It);
 vars.ele2_eRegrInput_log_bEtop_Over_bEMax= reader.GetFloat("eRegrInput_log_bEtop_Over_bEMax")->at(ele2It);
 vars.ele2_eRegrInput_log_bEbot_Over_bEMax= reader.GetFloat("eRegrInput_log_bEbot_Over_bEMax")->at(ele2It);
 vars.ele2_eRegrInput_log_bEleft_Over_bEMax= reader.GetFloat("eRegrInput_log_bEleft_Over_bEMax")->at(ele2It);
 vars.ele2_eRegrInput_log_bEright_Over_bEMax= reader.GetFloat("eRegrInput_log_bEright_Over_bEMax")->at(ele2It);
 vars.ele2_eRegrInput_asym_top_bottom= reader.GetFloat("eRegrInput_asym_top_bottom")->at(ele2It);

 vars.ele2_eRegrInput_asym_left_right= reader.GetFloat("eRegrInput_asym_left_right")->at(ele2It);
 vars.ele2_eRegrInput_Deta_bC2_sC= reader.GetFloat("eRegrInput_Deta_bC2_sC")->at(ele2It);
 vars.ele2_eRegrInput_Dphi_bC2_sC= reader.GetFloat("eRegrInput_Dphi_bC2_sC")->at(ele2It);
 vars.ele2_eRegrInput_bCE2_Over_sCE= reader.GetFloat("eRegrInput_bCE2_Over_sCE")->at(ele2It);
 vars.ele2_eRegrInput_e3x3_Over_bCE2= reader.GetFloat("eRegrInput_e3x3_Over_bCE2")->at(ele2It);
 vars.ele2_eRegrInput_e5x5_Over_bCE2= reader.GetFloat("eRegrInput_e5x5_Over_bCE2")->at(ele2It);
 vars.ele2_eRegrInput_sigietaieta_bC2= reader.GetFloat("eRegrInput_sigietaieta_bC2")->at(ele2It);
 vars.ele2_eRegrInput_sigiphiiphi_bC2= reader.GetFloat("eRegrInput_sigiphiiphi_bC2")->at(ele2It);
 vars.ele2_eRegrInput_sigietaiphi_bC2= reader.GetFloat("eRegrInput_sigietaiphi_bC2")->at(ele2It);
 vars.ele2_eRegrInput_bEMax_Over_bCE2= reader.GetFloat("eRegrInput_bEMax_Over_bCE2")->at(ele2It);
 vars.ele2_eRegrInput_log_bE2nd_Over_bEMax2= reader.GetFloat("eRegrInput_log_bE2nd_Over_bEMax2")->at(ele2It);
 vars.ele2_eRegrInput_log_bEtop_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEtop_Over_bEMax2")->at(ele2It);
 vars.ele2_eRegrInput_log_bEbot_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEbot_Over_bEMax2")->at(ele2It);
 vars.ele2_eRegrInput_log_bEleft_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEleft_Over_bEMax2")->at(ele2It);
 vars.ele2_eRegrInput_log_bEright_Over_bEMax2= reader.GetFloat("eRegrInput_log_bEright_Over_bEMax2")->at(ele2It);
 vars.ele2_eRegrInput_asym_top2_bottom2= reader.GetFloat("eRegrInput_asym_top2_bottom2")->at(ele2It);
 vars.ele2_eRegrInput_asym_left2_right2= reader.GetFloat("eRegrInput_asym_left2_right2")->at(ele2It);

 vars.ele2_eRegrInput_Deta_bCLow_sC= reader.GetFloat("eRegrInput_Deta_bCLow_sC")->at(ele2It);
 vars.ele2_eRegrInput_Dphi_bCLow_sC= reader.GetFloat("eRegrInput_Dphi_bCLow_sC")->at(ele2It);
 vars.ele2_eRegrInput_bCELow_Over_sCE= reader.GetFloat("eRegrInput_bCELow_Over_sCE")->at(ele2It);
 vars.ele2_eRegrInput_e3x3_Over_bCELow= reader.GetFloat("eRegrInput_e3x3_Over_bCELow")->at(ele2It);
 vars.ele2_eRegrInput_e5x5_Over_bCELow= reader.GetFloat("eRegrInput_e5x5_Over_bCELow")->at(ele2It);
 vars.ele2_eRegrInput_sigietaieta_bCLow= reader.GetFloat("eRegrInput_sigietaieta_bCLow")->at(ele2It);
 vars.ele2_eRegrInput_sigiphiiphi_bCLow= reader.GetFloat("eRegrInput_sigiphiiphi_bCLow")->at(ele2It);
 vars.ele2_eRegrInput_sigietaiphi_bCLow= reader.GetFloat("eRegrInput_sigiphiiphi_bCLow")->at(ele2It);
 vars.ele2_eRegrInput_Deta_bCLow2_sC= reader.GetFloat("eRegrInput_Deta_bCLow2_sC")->at(ele2It);
 vars.ele2_eRegrInput_Dphi_bCLow2_sC= reader.GetFloat("eRegrInput_Dphi_bCLow2_sC")->at(ele2It);
 vars.ele2_eRegrInput_bCELow2_Over_sCE= reader.GetFloat("eRegrInput_bCELow2_Over_sCE")->at(ele2It);
 vars.ele2_eRegrInput_e3x3_Over_bCELow2= reader.GetFloat("eRegrInput_e3x3_Over_bCELow2")->at(ele2It);
 vars.ele2_eRegrInput_e5x5_Over_bCELow2= reader.GetFloat("eRegrInput_e5x5_Over_bCELow2")->at(ele2It);
 vars.ele2_eRegrInput_sigietaieta_bCLow2= reader.GetFloat("eRegrInput_sigietaieta_bCLow2")->at(ele2It);
 vars.ele2_eRegrInput_sigiphiiphi_bCLow2= reader.GetFloat("eRegrInput_sigiphiiphi_bCLow2")->at(ele2It);
 vars.ele2_eRegrInput_sigietaiphi_bCLow2= reader.GetFloat("eRegrInput_sigietaiphi_bCLow2")->at(ele2It);
 ...
 vars.ele2_eRegrInput_bC2_eta= reader.GetFloat("eRegrInput_bC2_eta")->at(ele2It);
 vars.ele2_eRegrInput_bC2_phi= reader.GetFloat("eRegrInput_bC2_phi")->at(ele2It);
 vars.ele2_eRegrInput_bC2_eta_p5= reader.GetFloat("eRegrInput_bC2_eta_p5")->at(ele2It);
 vars.ele2_eRegrInput_bC2_phi_p2= reader.GetFloat("eRegrInput_bC2_phi_p2")->at(ele2It);
 vars.ele2_eRegrInput_bC2_bieta= reader.GetFloat("eRegrInput_bC2_bieta")->at(ele2It);
...
void SetDiElectronVariables(WZAnalysisVariables& vars, treeReader& reader)
{
  ...
  ROOT::Math::PtEtaPhiEVector ele1_sc_ZS(vars.ele1_scE_forZS*sin(2*atan(exp(-1.*vars.ele1_eta))),vars.ele1_eta,vars.ele1_phi,vars.ele1_scE_forZS);
  ROOT::Math::PtEtaPhiEVector ele2_sc_ZS(vars.ele2_scE_forZS*sin(2*atan(exp(-1.*vars.ele2_eta))),vars.ele2_eta,vars.ele2_phi,vars.ele2_scE_forZS);

  vars.ele1ele2_scMZS = (ele1_sc_ZS + ele2_sc_ZS).mass();
