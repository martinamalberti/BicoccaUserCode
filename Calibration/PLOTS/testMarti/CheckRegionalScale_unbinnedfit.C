...
//   h_EBRegion ->Draw("colz");
  ...
  //TFile* o = new TFile("plots/SMscale/TemplateOddEvents/checkSMscale_TemplateOddEvents.root","RECREATE");
  // TFile* o = new TFile("plots/SMscale/SingleTemplateMC/checkSMscale_TemplateMC.root","RECREATE");
  o -> cd();
