// g++ -Wall -o trisCheckStability `root-config --cflags --glibs` setTDRStyle.cc ntupleUtils.cc histoFunc.h trisCheckStability.cpp
/* ******************************************************
...
int main(int argc, char** argv)
{
  ...
  if(argc >= 10)
  {
    absEtaMin = atof(argv[9]);
    absEtaMax = atof(argv[10]);
  }
  if(argc >= 12)
  {
    IetaMin = atoi(argv[11]);
    IetaMax = atoi(argv[12]);
    IphiMin = atoi(argv[13]);
    IphiMax = atoi(argv[14]);
  }
  ...
  TCanvas* c_reference = new TCanvas("c_reference","reference",0,0,500,500);
  c_reference -> cd();
  h_template -> Draw();
  ...
  for(int ientry = 0; ientry < nEntries; ++ientry)
  {
    ...
    float y = 1.+(1/scLaserCorr-1.)*1.35;
    if (timeStampHigh>1313.4e+6) y = y+0.000;
    if (timeStampHigh<1313.4e+6 && timeStampHigh>1310.0e+6) y = y+0.003;
    if (timeStampHigh<1310.0e+6 && timeStampHigh>1308.5e+6) y = y+0.0025;
    if (timeStampHigh<1308.5e+6 && timeStampHigh>1305.0e+6) y = y+0.0045;
    if (timeStampHigh<1305.5e+6) y = y+0.003;
    
    (h_EoC[bin]) -> Fill(EoP);
    //(h_EoC[bin]) -> Fill(EoP/scLaserCorr/y);
  ...
  h_scOccupancy_eta -> GetXaxis() -> SetTitleSize(0.04);
  h_scOccupancy_eta -> GetXaxis() -> SetLabelSize(0.04);
  h_scOccupancy_eta -> GetYaxis() -> SetTitle("events");
  h_scOccupancy_eta -> GetYaxis() -> SetTitleSize(0.04);
  h_scOccupancy_eta -> GetYaxis() -> SetTitleOffset(1.5);
  h_scOccupancy_eta -> GetYaxis() -> SetLabelSize(0.04);
  h_scOccupancy_eta -> Draw();
  
  c_scOccupancy -> cd(2);
  h_scOccupancy_phi -> GetXaxis() -> SetTitle("sc #phi");
  h_scOccupancy_phi -> GetXaxis() -> SetTitleSize(0.04);
  h_scOccupancy_phi -> GetXaxis() -> SetLabelSize(0.04);
  h_scOccupancy_phi -> GetYaxis() -> SetTitle("events");
  h_scOccupancy_phi -> GetYaxis() -> SetTitleSize(0.04);
  h_scOccupancy_phi -> GetYaxis() -> SetTitleOffset(1.5);
  h_scOccupancy_phi -> GetYaxis() -> SetLabelSize(0.04);
  ...
  h_seedOccupancy_EB -> GetXaxis() -> SetTitleSize(0.04);
  h_seedOccupancy_EB -> GetXaxis() -> SetLabelSize(0.04);
  h_seedOccupancy_EB -> GetYaxis() -> SetTitle("seed i#phi");
  h_seedOccupancy_EB -> GetYaxis() -> SetTitleSize(0.04);
  h_seedOccupancy_EB -> GetYaxis() -> SetTitleOffset(1.5);
  h_seedOccupancy_EB -> GetYaxis() -> SetLabelSize(0.04);
  h_seedOccupancy_EB -> Draw("COLZ");
  
  c_seedOccupancy -> cd(2);
  h_seedOccupancy_EEp -> GetXaxis() -> SetTitle("seed ix");
  h_seedOccupancy_EEp -> GetXaxis() -> SetTitleSize(0.04);
  h_seedOccupancy_EEp -> GetXaxis() -> SetLabelSize(0.04);
  h_seedOccupancy_EEp -> GetYaxis() -> SetTitle("seed iy");
  h_seedOccupancy_EEp -> GetYaxis() -> SetTitleSize(0.04);
  h_seedOccupancy_EEp -> GetYaxis() -> SetTitleOffset(1.5);
  h_seedOccupancy_EEp -> GetYaxis() -> SetLabelSize(0.04);
  h_seedOccupancy_EEp -> Draw("COLZ");
  
  c_seedOccupancy -> cd(3);
  h_seedOccupancy_EEm -> GetXaxis() -> SetTitle("seed ix");
  h_seedOccupancy_EEm -> GetXaxis() -> SetTitleSize(0.04);
  h_seedOccupancy_EEm -> GetXaxis() -> SetLabelSize(0.04);
  h_seedOccupancy_EEm -> GetYaxis() -> SetTitle("seed iy");
  h_seedOccupancy_EEm -> GetYaxis() -> SetTitleSize(0.04);
  h_seedOccupancy_EEm -> GetYaxis() -> SetTitleOffset(1.5);
  h_seedOccupancy_EEm -> GetYaxis() -> SetLabelSize(0.04);
  ...
  {  
    ...
    g_las -> SetPoint(i, (float)AveTime[i], 1./h_Las[i]->GetMean());
  }  
