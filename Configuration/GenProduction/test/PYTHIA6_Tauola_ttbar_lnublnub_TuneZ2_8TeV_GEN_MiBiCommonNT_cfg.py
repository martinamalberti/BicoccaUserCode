...
process.TFileService = cms.Service(
    "TFileService",
    fileName = cms.string("PYTHIA6_Tauola_ttbar_lnublnub_TuneZ2_8TeV_GEN.root"),
...
process.MiBiCommonNTGen = process.SimpleNtupleGen.clone()
process.MiBiCommonNTGen.saveGenTTBar   = cms.untracked.bool(True)
process.MiBiCommonNTGen.saveGenHiggs   = cms.untracked.bool(False)
process.MiBiCommonNTGen.saveGenHiggsWW = cms.untracked.bool(False)

# Path and EndPath definitions
process.generation_step = cms.Path(process.pgen)
process.endjob_step = cms.Path(process.endOfProcess)
process.RECOSIMoutput_step = cms.EndPath(process.RECOSIMoutput)
process.ntuple_step = cms.EndPath(process.MiBiCommonNTGen)

# Schedule definition
#process.schedule = cms.Schedule(process.generation_step,process.endjob_step,process.RECOSIMoutput_step)
process.schedule = cms.Schedule(process.generation_step,process.endjob_step,process.ntuple_step)
