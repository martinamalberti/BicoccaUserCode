...
process.source = cms.Source("PoolSource",
   ...
   '/store//relval/CMSSW_3_6_1/RelValWE/GEN-SIM-RECO/START36_V7-v1/0019/D0116268-FC5C-DF11-82FC-001A92971B08.root '                                            )
)
...
process.TFileService = cms.Service("TFileService",
   fileName = cms.string("/tmp/amassiro/treeWenuMC.root")
)
