...
process.GlobalTag.toGet = cms.VPSet(
  cms.PSet(
           ...
           connect = cms.untracked.string("sqlite_file:produce/EBAlign_2010.db")
          ),
  cms.PSet(
           record = cms.string("EEAlignmentRcd"),
           tag = cms.string("EEAlignment_measured_v04_offline"),
           connect = cms.untracked.string("sqlite_file:produce/EEAlign_2010.db")
          )
)
...
#process.pReRECO = cms.Sequence(process.siPixelRecHits*process.siStripMatchedRecHits*process.newSeedFromPairs*process.newSeedFromTriplets*process.newCombinedSeeds*process.ecalClusters*process.gsfElectronSequence)
...
process.patElectrons.electronSource = cms.InputTag("gsfElectrons::simpleNtpleDATA")
...
process.AllPassFilterPetDefaultSequence = process.AllPassFilter.clone()
...
process.p = cms.Path(
    ...
    *process.AllPassFilterPetDefaultSequence
    *process.simpleNtple
    )
