...
print CONFIGNAMECRAB "return_data = 0\n";
...
print CONFIGNAMECRAB "storage_element = pcteragw01.mib.infn.it\n";
print CONFIGNAMECRAB "storage_path = /dpm/mib.infn.it/home/cms/store/users/tancini/leptSkim/$OUTDIR\n"; 
...
$NEWDIR = "/dpm/mib.infn.it/home/cms/store/users/tancini/leptSkim/".$OUTDIR;  
