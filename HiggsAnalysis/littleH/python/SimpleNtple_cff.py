...
def makeSimpleNtple(process, GlobalTag, MC=False, HLT='HLT', HLT_filter_ele=False, HLT_filter_mu=False):
    ...
    process.makeNtple = process.SimpleNtple.clone()
...
#    from PhysicsTools.NtupleUtils.HLTrigResultsDumper_cfi import *
    ...
    process.TriggerResults.HLTPaths = cms.vstring('HLT_Mu3', 'HLT_Mu5', 'HLT_Mu9')   # provide list of HLT paths (or patterns) you want
