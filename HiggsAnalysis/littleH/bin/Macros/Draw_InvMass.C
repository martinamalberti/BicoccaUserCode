void Draw_InvMass () {
  ...
  double bkg_SM_genMCevts [n_bkg_SM] = {  800000., 10000., 10000., 10000. } ;
...
/*    can[i]->SetGridx () ;
  ...
  //SM BKG
    ...
    leg [i] ->Draw() ;
    std::cout << Lum << endl;
    s_plot_name = "~/www/little" + v_leg_signal_names [i] +"_" + Lum + "pb_" + "tanB"+ tanB + ".gif" ;

    can [i] -> Print ( s_plot_name, "gif" ) ;
    s_plot_name = "~/www/little" + v_leg_signal_names [i] + "_" + Lum + "pb_" + "tanB"+ tanB +".eps" ;
