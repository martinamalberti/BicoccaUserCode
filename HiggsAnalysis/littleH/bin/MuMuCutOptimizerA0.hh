#ifndef MuMuCutOptimizerA0_h
#define MuMuCutOptimizerA0_h
...
class MuMuCutOptimizerA0 : public smallHBaseClass{
public:
  
  MuMuCutOptimizerA0(TChain *tree=0);
  virtual ~MuMuCutOptimizerA0() {};
  void bookHistos();
