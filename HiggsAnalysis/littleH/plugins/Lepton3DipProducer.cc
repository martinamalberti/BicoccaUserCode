...
//
// Package:    littleH
// Class:      Lepton3DipProducer
// 
/**\class SimpleNtple Lepton3DipProducer.cc HiggsAnalysis/littleH/Lepton3DipProducer.cc
...
// $Id: Lepton3DipProducer.cc,v 1.1 2010/01/19 10:24:28 dimatteo Exp $
//
//
...
Lepton3DipProducer::Lepton3DipProducer(const edm::ParameterSet& iConfig):
...
Lepton3DipProducer::~Lepton3DipProducer()
{}
...
void Lepton3DipProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
