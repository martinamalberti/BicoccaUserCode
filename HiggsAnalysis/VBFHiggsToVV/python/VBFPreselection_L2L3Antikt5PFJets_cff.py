...
VBFEtMinPFJetCountFilterL2L3Antikt5PFJets.etMin = cms.double(15.)
...
VBFNtupleL2L3Antikt5PFJets = SimpleNtple.clone()

VBFNtupleL2L3Antikt5PFJets.EleTag = cms.InputTag("gsfElectrons")
VBFNtupleL2L3Antikt5PFJets.doEleRefCheck = cms.untracked.bool(True)
VBFNtupleL2L3Antikt5PFJets.EleRefTag = cms.InputTag("VBFIdSelectedElectronsRefAll")
VBFNtupleL2L3Antikt5PFJets.Ele3DipSignificanceTag = cms.InputTag("VBFLepton3DipProducerAll:Ele3DipSignificanceMap")
VBFNtupleL2L3Antikt5PFJets.EleTipSignificanceTag = cms.InputTag("VBFLeptonTipLipProducerAll:EleTipSignificanceMap")
VBFNtupleL2L3Antikt5PFJets.EleLipSignificanceTag = cms.InputTag("VBFLeptonTipLipProducerAll:EleLipSignificanceMap")

VBFNtupleL2L3Antikt5PFJets.MuTag = cms.InputTag("muons")
VBFNtupleL2L3Antikt5PFJets.doMuRefCheck = cms.untracked.bool(True)
VBFNtupleL2L3Antikt5PFJets.MuRefTag = cms.InputTag("VBFIsolatedMuonsRefAll")
VBFNtupleL2L3Antikt5PFJets.Mu3DipSignificanceTag = cms.InputTag("VBFLepton3DipProducerAll:Mu3DipSignificanceMap")
VBFNtupleL2L3Antikt5PFJets.MuTipSignificanceTag = cms.InputTag("VBFLeptonTipLipProducerAll:MuTipSignificanceMap")
VBFNtupleL2L3Antikt5PFJets.MuLipSignificanceTag = cms.InputTag("VBFLeptonTipLipProducerAll:MuLipSignificanceMap")
...
VBFNtupleL2L3Antikt5PFJets.genJetTag = cms.InputTag("ak5GenJets")

VBFNtupleL2L3Antikt5PFJets.Type1MetTag = cms.InputTag("VBFType1Antikt5CaloMet")

VBFNtupleL2L3Antikt5PFJets.saveMu          = cms.untracked.bool(True)
VBFNtupleL2L3Antikt5PFJets.saveTrack       = cms.untracked.bool(False)
VBFNtupleL2L3Antikt5PFJets.saveEle         = cms.untracked.bool(True)
VBFNtupleL2L3Antikt5PFJets.saveJet         = cms.untracked.bool(False)
...
VBFPreselectionSequenceL2L3Antikt5PFJets = cms.Sequence(
