...
VBFSelectedPFJetsAntikt5PFJets.etMin = cms.double(15.)
...
VBFSelectedPFJetsRefAntikt5PFJets.etMin = cms.double(15.)
...
VBFNtupleAntikt5PFJets.genJetTag = cms.InputTag("sisCone5GenJets")
