#ifndef VBFLepton3DipProducer_h
#define VBFLepton3DipProducer_h

/* Class VBFLepton3DipProducer
 *
...
class VBFLepton3DipProducer : public edm::EDProducer
{
 ...
 public:
  ...
  //! ctor
  VBFLepton3DipProducer(const edm::ParameterSet&);
