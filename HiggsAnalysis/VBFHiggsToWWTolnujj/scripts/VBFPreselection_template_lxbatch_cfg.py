...
process.VBFNtupleCaloJetsSisCone5CaloJets.fileName = cms.untracked.string("OUTPUTSAVEFOLDER/OUTPUTFILENAME_sisCone5CaloJets_JOBIT.root")

process.VBFNtupleCaloJetsCorrectedSisCone5CaloJets.eventType = cms.untracked.int32(EVENTTYPE)
process.VBFNtupleCaloJetsCorrectedSisCone5CaloJets.fileName = cms.untracked.string("OUTPUTSAVEFOLDER/OUTPUTFILENAME_correctedSisCone5CaloJets_JOBIT.root")

process.VBFNtuplePFJetsSisCone5PFJets.eventType = cms.untracked.int32(EVENTTYPE)
process.VBFNtuplePFJetsSisCone5PFJets.fileName = cms.untracked.string("OUTPUTSAVEFOLDER/OUTPUTFILENAME_sisCone5PFJets_JOBIT.root")
