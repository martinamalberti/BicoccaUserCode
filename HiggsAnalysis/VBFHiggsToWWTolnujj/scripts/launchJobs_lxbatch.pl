...
$LISTFile = "./list.txt" ;
system ("rfdir ".$INPUTSAVEFolder." | grep CMSSWfile | awk '{print \$9}' > ".$LISTFile."\n") ;
...
print "NumberOfJobs = ".$jobNumber."\n";
 ...
 print ("rfmkdir ".$OUTPUTSAVEFolder."\n") ;
 system ("rfmkdir ".$OUTPUTSAVEFolder."\n") ;
 print ("rfchmod 777 ".$OUTPUTSAVEFolder."\n") ;
 system ("rfchmod 777 ".$OUTPUTSAVEFolder."\n") ;
...
{ 
  ...
  $tempo1 = "./tempo1" ;
  system ("cat ".$LOCALFolder."/".$CMSSWCfgTemplate."   | sed -e s%LOCALFOLDER%".$LOCALFolder.
  ...
  $command = "rfcp /tmp/".$OUTPUTFileName."_sisCone5CaloJets_".$jobIt.".root ".$OUTPUTSAVEFolder; 
  system ("echo ".$command." >> ".$tempBjob) ;

  $command = "rfcp /tmp/".$OUTPUTFileName."_correctedSisCone5CaloJets_".$jobIt.".root ".$OUTPUTSAVEFolder; 
  system ("echo ".$command." >> ".$tempBjob) ;

  $command = "rfcp /tmp/".$OUTPUTFileName."_sisCone5PFJets_".$jobIt.".root ".$OUTPUTSAVEFolder; 
  system ("echo ".$command." >> ".$tempBjob) ;
