//COMPILO cc++ -o doIt_all_VBF_global -lm `root-config --cflags --libs --glibs` doIt_all_VBF_global.cpp
// $Id: doIt_ee.cpp,v 1.1 2008/06/02 17:15:13 tancini Exp $
