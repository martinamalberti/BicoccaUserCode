...
TFile H130 ("testVBFIsolation_H130_new.root") ;
TFile WW ("testVBFIsolation_WW_new.root") ;
TH1F * H_H130_WO = (TH1F *) H130->Get ("testIsol/NEWIsoValueWO") ;
TH1F * H_H130_W = (TH1F *) H130->Get ("testIsol/NEWIsoValueW") ;
TH1F * H_WW_W = (TH1F *) WW->Get ("testIsol/NEWIsoValueW") ; 
TH1F * H_WW_WO = (TH1F *) WW->Get ("testIsol/NEWIsoValueWO") ;
H_H130_WO->SetFillStyle (3018) ;
H_H130_WO->SetFillColor (38) ;
H_H130_WO->SetLineWidth (2) ;
H_H130_WO->GetXaxis ()->SetTitle ("isol WO") ;
H_WW_WO->SetLineWidth (2) ;
H_WW_WO->SetLineColor (2) ;
TCanvas c1 ;
c1->SetLogy () ;
H_H130_WO->DrawNormalized () ;
H_WW_WO->DrawNormalized ("same") ;
H_H130_W->SetFillColor (38) ;
H_H130_W->SetFillStyle (3018) ;
H_H130_W->SetLineWidth (2) ;
H_WW_W->SetLineWidth (2) ;
H_WW_W->SetLineColor (2) ;
H_H130_W->GetXaxis ()->SetTitle ("isol W") ;
TCanvas c2 ;
c2->SetLogy () ;
H_H130_W->DrawNormalized () ;
H_WW_W->DrawNormalized ("same") ;
