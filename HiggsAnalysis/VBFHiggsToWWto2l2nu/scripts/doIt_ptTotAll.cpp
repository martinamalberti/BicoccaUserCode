...
// $Id: doIt_ptTotAll.cpp,v 1.2 2008/06/24 13:37:03 tancini Exp $
...
{ 
  ...
  chain_Zmumu_0_15->Add ("/gwtera2/users/govoni/ntuples/Zmumu_0_15/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_15_20->Add ("/gwtera2/users/govoni/ntuples/Zmumu_15_20/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_20_30->Add ("/gwtera2/users/govoni/ntuples/Zmumu_20_30/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_30_50->Add ("/gwtera2/users/govoni/ntuples/Zmumu_30_50/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_50_80->Add ("/gwtera2/users/govoni/ntuples/Zmumu_50_80/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_80_120->Add ("/gwtera2/users/govoni/ntuples/Zmumu_80_120/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_120_170->Add ("/gwtera2/users/govoni/ntuples/Zmumu_120_170/NTUPLE*_output_*.root");
  ...
  chain_Zmumu_170_230->Add ("/gwtera2/users/govoni/ntuples/Zmumu_170_230/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_0_15->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_0_15/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_15_20->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_15_20/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_20_30->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_20_30/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_30_50->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_30_50/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_50_80->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_50_80/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_80_120->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_80_120/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_120_170->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_120_170/NTUPLE*_output_*.root");
  ...
  chain_Wmunuj_170_230->Add ("/gwtera2/users/govoni/ntuples/Wmunuj_170_230/NTUPLE*_output_*.root");
  ...
  TChain * chain_WW0j = new TChain ("ntpla/VBFSimpleTree") ;
  chain_WW0j->Add ("/gwtera2/users/govoni/ntuples/WW0j/NTUPLE*_output_*.root");
  histos h_WW0j (g_prefix + "_WW0j", g_cutsNum);
  selector (chain_WW0j, h_WW0j) ;

  TChain * chain_WW1j = new TChain ("ntpla/VBFSimpleTree") ;
  chain_WW1j->Add ("/gwtera2/users/govoni/ntuples/WW1j/NTUPLE*_output_*.root");
  histos h_WW1j (g_prefix + "_WW1j", g_cutsNum);
  selector (chain_WW1j, h_WW1j) ;

  TChain * chain_WW2j = new TChain ("ntpla/VBFSimpleTree") ;
  chain_WW2j->Add ("/gwtera2/users/govoni/ntuples/WW2j/NTUPLE*_output_*.root");
  histos h_WW2j (g_prefix + "_WW2j", g_cutsNum);
  selector (chain_WW2j, h_WW2j) ;

  TChain * chain_WW3j = new TChain ("ntpla/VBFSimpleTree") ;
  chain_WW3j->Add ("/gwtera2/users/govoni/ntuples/WW3j/NTUPLE*_output_*.root");
  ...
  for (int i=0 ; i < h_H160.m_eff.size () ; i++)
    {
      ...
      std::cout << "i = " << i <<" Zee_0_15 "<<h_Zee_0_15.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_15_20 "<<h_Zee_15_20.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_20_30 "<<h_Zee_20_30 .m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_30_50 "<<h_Zee_30_50.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_50_80 "<<h_Zee_50_80.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_80_120 "<<h_Zee_80_120.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_120_170 "<<h_Zee_120_170 .m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zee_170_230 "<<h_Zee_170_230 .m_counter.at (i) << std::endl;

      std::cout << "i = " << i <<" Wenj_0_15 "<<h_Wenj_0_15.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_15_20 "<<h_Wenj_15_20.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_20_30 "<<h_Wenj_20_30.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_30_50 "<<h_Wenj_30_50.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_50_80 "<<h_Wenj_50_80.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_80_120 "<<h_Wenj_80_120.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_120_170 "<<h_Wenj_120_170.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wenj_170_230 "<<h_Wenj_170_230.m_counter.at (i) << std::endl;

      std::cout << "i = " << i <<" Zmumu_0_15 "<<h_Zmumu_0_15.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_15_20 "<<h_Zmumu_15_20.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_20_30 "<<h_Zmumu_20_30.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_30_50 "<<h_Zmumu_30_50.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_50_80 "<<h_Zmumu_50_80.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_80_120 "<<h_Zmumu_80_120.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_120_170 "<<h_Zmumu_120_170.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Zmumu_170_230 "<<h_Zmumu_170_230.m_counter.at (i) << std::endl;

      std::cout << "i = " << i <<" Wmunuj_0_15 "<<h_Wmunuj_0_15.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_15_20 "<<h_Wmunuj_15_20.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_20_30 "<<h_Wmunuj_20_30.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_30_50 "<<h_Wmunuj_30_50.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_50_80 "<<h_Wmunuj_50_80.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_80_120 "<<h_Wmunuj_80_120.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_120_150 "<<h_Wmunuj_120_170.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" Wmunuj_170_230 "<<h_Wmunuj_170_230.m_counter.at (i) << std::endl;

      std::cout << "i = " << i <<" WW_incl "<<h_WW_incl.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" ZZ_incl "<<h_ZZ_incl.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" WZ_incl "<<h_WZ_incl.m_counter.at (i) << std::endl;

      std::cout << "i = " << i <<" WW0j "<<h_WW0j.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" WW1j "<<h_WW1j.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" WW2j "<<h_WW2j.m_counter.at (i) << std::endl;
      std::cout << "i = " << i <<" WW3j "<<h_WW3j.m_counter.at (i) << std::endl;
  ...
  for (int i=0 ; i < h_H160.m_eff.size () ; i++)
    {
      double weightedSumBkg =
        ...
        0.0 * 0.311488 * (h_WW0j.m_eff.at (i)) +
        5.9* 0.397727 * (h_WW1j.m_eff.at (i)) +
        4.0* 0.480837 * (h_WW2j.m_eff.at (i)) +
        2.3* 0.618994 * (h_WW3j.m_eff.at (i)) +
        ...
        236.2 * 0.184877 * (h_Wenj_80_120.m_eff.at (i))+ 
        70.72 * 0.208953 * (h_Wenj_120_170.m_eff.at (i)) + 
        20.36 * 0.223205 * (h_Wenj_170_230.m_eff.at (i)) + // Wenj


	17170 * 0.1103 * 0.0409474 * (h_Wmunuj_0_15.m_eff.at (i)) + 
        ...
        20.36 * 0.248835 * (h_Wmunuj_170_230.m_eff.at (i)) + // Wmunj
	...
	353.1 * 0.293118 * (h_Zee_15_20.m_eff.at (i)) + 
        ...
        353.1 * 0.35025 * (h_Zmumu_15_20.m_eff.at (i)) + 
        326.7 * 0.408136 * (h_Zmumu_20_30.m_eff.at (i)) + 
        227.0 * 0.48449 * (h_Zmumu_30_50.m_eff.at (i)) + 
	...
	0.82 * 0.715106 * (h_tt4j.m_eff.at (i)) + //ttnj
      ...
      signalEff.push_back (0.119 * 0.48371 * h_H160.m_eff.at (i)) ;  
      bkgEff.push_back (weightedSumBkg) ;  
      m_significance.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
...
double weightedSumBkg_top =
 ...
 m_significance_top.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
                               sqrt (Lumi * weightedSumBkg_top)) ;

 bkgEff_Zeej.push_back (weightedSumBkg_Zeej) ;  
 m_significance_Zeej.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
				sqrt (Lumi * weightedSumBkg_Zeej)) ;
                                                           
 bkgEff_Wenj.push_back (weightedSumBkg_Wenj) ;  
 m_significance_Wenj.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
				sqrt (Lumi * weightedSumBkg_Wenj)) ;                                                                                                                                                                                                                          
 bkgEff_Zmumuj.push_back (weightedSumBkg_Zmumuj) ;
 m_significance_Zmumuj.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
				  sqrt (Lumi * weightedSumBkg_Zmumuj)) ;

 bkgEff_Wmunuj.push_back (weightedSumBkg_Wmunuj) ;
 m_significance_Wmunuj.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
				  sqrt (Lumi * weightedSumBkg_Wmunuj)) ;         

 bkgEff_VV.push_back (weightedSumBkg_VV) ;  
 m_significance_VV.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
			      sqrt (Lumi * weightedSumBkg_VV)) ;

 bkgEff_WWnj.push_back (weightedSumBkg_WWnj) ;
 m_significance_WWnj.push_back (Lumi * 0.119 * 0.48371 * h_H160.m_eff.at (i) /
...
//      if (((TLorentzVector*) (MET->At (0)))->Pt () < g_METMin) continue ; plots.increase (cutId++) ; //PG 10
      ...
      if (primoTAG->Eta () < secondoTAG->Eta ())
        {
	  std::swap (primoTAG, secondoTAG) ;
        }
