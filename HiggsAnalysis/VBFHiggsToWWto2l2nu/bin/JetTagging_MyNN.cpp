...
// //    }
   ...
   for (int l=0; l<otherJets->GetEntries (); l++ ){ //--- loop over otherJets ----
    TLorentzVector* myparticle_1 = (TLorentzVector*) otherJets->At(l);
    double flagNN = myNN.Value(0,myparticle_1->Px(),myparticle_1->Py(),myparticle_1->Pz(),myparticle_1->E());
   ...
   if (tagJets_NN.first != -1 && tagJets_NN.second != -1){
    TLorentzVector* myRecoJet_1 = (TLorentzVector*) otherJets->At(maxNNNum1);   
    TLorentzVector* myRecoJet_2 = (TLorentzVector*) otherJets->At(maxNNNum2);
