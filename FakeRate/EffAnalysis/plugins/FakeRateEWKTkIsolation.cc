...
FakeRateEWKTkIsolation::FakeRateEWKTkIsolation(const edm::ParameterSet& conf)
{
...
FakeRateEWKTkIsolation::~FakeRateEWKTkIsolation()
{
}

void FakeRateEWKTkIsolation::select(edm::Handle<reco::PixelMatchGsfElectronCollection> c, const edm::Event& e)
{
