...
struct histos2
{
  ...
  histos2 (int ptHat = 0) :
    ...
    m_counter (0)
    {
      ...
      m_baseName = basename ;
      m_e_single_resol_eta  = new TH1F ((m_baseName + std::string ("m_e_single_resol_eta" )).c_str () , (m_baseName + std::string ("m_e_single_resol_eta" )).c_str (), 100, -2.5, 2.5) ;
      m_e_single_resol_ptE  = new TH1F ((m_baseName + std::string ("m_e_single_resol_ptE" )).c_str () , (m_baseName + std::string ("m_e_single_resol_ptE" )).c_str (), 40, 0, 200) ;
      m_e_single_resol_ptJ  = new TH1F ((m_baseName + std::string ("m_e_single_resol_ptJ" )).c_str () , (m_baseName + std::string ("m_e_single_resol_ptJ" )).c_str (), 40, 0, 200) ;
      m_e_single_tkIso_eta  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_eta" )).c_str () , (m_baseName + std::string ("m_e_single_tkIso_eta" )).c_str (), 100, -2.5, 2.5) ;
      m_e_single_tkIso_ptE  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_ptE" )).c_str () , (m_baseName + std::string ("m_e_single_tkIso_ptE" )).c_str (), 40, 0, 200) ;
      m_e_single_tkIso_ptJ  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_ptJ" )).c_str () , (m_baseName + std::string ("m_e_single_tkIso_ptJ" )).c_str (), 40, 0, 200) ;
      m_e_single_hadIso_eta = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_eta")).c_str () , (m_baseName + std::string ("m_e_single_hadIso_eta")).c_str (), 100, -2.5, 2.5) ; 
      m_e_single_hadIso_ptE = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_ptE")).c_str () , (m_baseName + std::string ("m_e_single_hadIso_ptE")).c_str (), 40, 0, 200) ;
      m_e_single_hadIso_ptJ = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_ptJ")).c_str () , (m_baseName + std::string ("m_e_single_hadIso_ptJ")).c_str (), 40, 0, 200) ;
      m_e_single_eleId_eta  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_eta" )).c_str () , (m_baseName + std::string ("m_e_single_eleId_eta" )).c_str (), 100, -2.5, 2.5) ;
      m_e_single_eleId_ptE  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_ptE" )).c_str () , (m_baseName + std::string ("m_e_single_eleId_ptE" )).c_str (), 40, 0, 200) ;
      m_e_single_eleId_ptJ  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_ptJ" )).c_str () , (m_baseName + std::string ("m_e_single_eleId_ptJ" )).c_str (), 40, 0, 200) ;
      m_e_single_eleIdLoose_eta  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_eta" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_eta")).c_str () , 100, -2.5, 2.5) ;
      m_e_single_eleIdLoose_ptE  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_ptE" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_ptE")).c_str () , 40, 0, 200) ;
      m_e_single_eleIdLoose_ptJ  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_ptJ" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_ptJ")).c_str () , 40, 0, 200) ;
      m_e_single_eleIdTight_eta  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_eta" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_eta")).c_str () , 100, -2.5, 2.5) ;
      m_e_single_eleIdTight_ptE  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_ptE" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_ptE")).c_str () , 40, 0, 200) ;
      m_e_single_eleIdTight_ptJ  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_ptJ" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_ptJ")).c_str () , 40, 0, 200) ;
      m_e_single_resol_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_single_resol_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_single_resol_EMfrac" )).c_str (), 100, -2.5, 2.5) ;
      m_e_single_tkIso_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_single_tkIso_EMfrac" )).c_str (), 100, -2.5, 2.5) ;
      m_e_single_hadIso_EMfrac = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_EMfrac")).c_str () , (m_baseName + std::string ("m_e_single_hadIso_EMfrac")).c_str (), 100, -2.5, 2.5) ; 
      m_e_single_eleId_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_single_eleId_EMfrac" )).c_str (), 100, -2.5, 2.5) ;
      m_e_single_eleIdLoose_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_EMfrac")).c_str () , 100, -2.5, 2.5) ;
      m_e_single_eleIdTight_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_EMfrac")).c_str () , 100, -2.5, 2.5) ;
      ...
      m_e_sequence_resol_ptE  = new TH1F ((m_baseName + std::string ("m_e_sequence_resol_ptE" )).c_str () , (m_baseName + std::string ("m_e_sequence_resol_ptE" )).c_str (),  40, 0, 200) ;
      ...
      m_e_sequence_tkIso_ptE  = new TH1F ((m_baseName + std::string ("m_e_sequence_tkIso_ptE" )).c_str () , (m_baseName + std::string ("m_e_sequence_tkIso_ptE" )).c_str (),  40, 0, 200) ;
      ...
      m_e_sequence_hadIso_eta = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_eta")).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_eta")).c_str (),  100, -2.5, 2.5) ;
      m_e_sequence_hadIso_ptE = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_ptE")).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_ptE")).c_str (),  40, 0, 200) ;
      m_e_sequence_hadIso_ptJ = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_ptJ")).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_ptJ")).c_str (),  40, 0, 200) ;
      m_e_sequence_eleId_eta  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_eta" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_eta" )).c_str (),  100, -2.5, 2.5) ;
      m_e_sequence_eleId_ptE  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_ptE" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_ptE" )).c_str (),  40, 0, 200) ;
      m_e_sequence_eleId_ptJ  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_ptJ" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_ptJ" )).c_str (),  40, 0, 200) ;
      m_e_sequence_eleIdLoose_eta  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_eta" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_eta")).c_str () ,  100, -2.5, 2.5) ;
      m_e_sequence_eleIdLoose_ptE  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_ptE" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_ptE")).c_str () ,  40, 0, 200) ;
      m_e_sequence_eleIdLoose_ptJ  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_ptJ" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_ptJ")).c_str () ,  40, 0, 200) ;
      ...
      m_e_sequence_eleIdTight_ptE  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdTight_ptE" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdTight_ptE")).c_str () ,  40, 0, 200) ;
      ...
      m_e_sequence_resol_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_sequence_resol_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_sequence_resol_EMfrac" )).c_str (), 100, -2.5, 2.5) ;
      m_e_sequence_tkIso_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_sequence_tkIso_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_sequence_tkIso_EMfrac" )).c_str (), 100, -2.5, 2.5) ;
      m_e_sequence_hadIso_EMfrac = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_EMfrac")).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_EMfrac")).c_str (), 100, -2.5, 2.5) ; 
      m_e_sequence_eleId_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_EMfrac" )).c_str (), 100, -2.5, 2.5) ;
      m_e_sequence_eleIdLoose_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_EMfrac")).c_str () , 100, -2.5, 2.5) ;
      m_e_sequence_eleIdTight_EMfrac  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdTight_EMfrac" )).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdTight_EMfrac")).c_str () , 100, -2.5, 2.5) ;
      ...
      for (int i = 0 ; i < 5 ; ++i)
        {
          ...
          m_e_single_resol_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_resol_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_resol_eta_") + names[i]).c_str () , 100, -2.5, 2.5) ;
          m_e_single_resol_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_resol_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_resol_ptE_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_resol_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_resol_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_resol_ptJ_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_tkIso_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_tkIso_eta_") + names[i]).c_str () , 100, -2.5, 2.5) ;
          m_e_single_tkIso_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_tkIso_ptE_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_tkIso_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_tkIso_ptJ_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_hadIso_eta_flav[i] = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_hadIso_eta_") + names[i]).c_str () , 100, -2.5, 2.5) ; 
          m_e_single_hadIso_ptE_flav[i] = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_hadIso_ptE_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_hadIso_ptJ_flav[i] = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_hadIso_ptJ_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleId_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleId_eta_") + names[i]).c_str () , 100, -2.5, 2.5) ;
          m_e_single_eleId_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleId_ptE_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleId_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleId_ptJ_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleIdLoose_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_eta_") + names[i]).c_str () , 100, -2.5, 2.5) ;
          m_e_single_eleIdLoose_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_ptE_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleIdLoose_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_ptJ_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleIdTight_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_eta_") + names[i]).c_str () , 100, -2.5, 2.5) ;
          m_e_single_eleIdTight_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_ptE_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleIdTight_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_ptJ_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_resol_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_resol_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_resol_EMfrac_") + names[i]).c_str ()  , 40, 0, 200) ;
          m_e_single_tkIso_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_tkIso_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_tkIso_EMfrac_") + names[i]).c_str ()  , 40, 0, 200) ;
          m_e_single_hadIso_EMfrac_flav[i] = new TH1F ((m_baseName + std::string ("m_e_single_hadIso_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_hadIso_EMfrac_") + names[i]).c_str () , 40, 0, 200) ; 
          m_e_single_eleId_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleId_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleId_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleIdLoose_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdLoose_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdLoose_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_single_eleIdTight_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_single_eleIdTight_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_single_eleIdTight_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          ...
          m_e_sequence_resol_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_resol_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_resol_ptE_") + names[i]).c_str () ,  40, 0, 200) ;
          ...
          m_e_sequence_tkIso_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_tkIso_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_tkIso_ptE_") + names[i]).c_str () ,  40, 0, 200) ;
          ...
          m_e_sequence_hadIso_eta_flav[i] = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_eta_") + names[i]).c_str () ,  100, -2.5, 2.5) ;
          m_e_sequence_hadIso_ptE_flav[i] = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_ptE_") + names[i]).c_str () ,  40, 0, 200) ;
          m_e_sequence_hadIso_ptJ_flav[i] = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_ptJ_") + names[i]).c_str () ,  40, 0, 200) ;
          m_e_sequence_eleId_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_eta_") + names[i]).c_str () ,  100, -2.5, 2.5) ;
          m_e_sequence_eleId_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_ptE_") + names[i]).c_str () ,  40, 0, 200) ;
          m_e_sequence_eleId_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_ptJ_") + names[i]).c_str () ,  40, 0, 200) ;
          m_e_sequence_eleIdLoose_eta_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_eta_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_eta_") + names[i]).c_str () ,  100, -2.5, 2.5) ;
          m_e_sequence_eleIdLoose_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_ptE_") + names[i]).c_str () ,  40, 0, 200) ;
          m_e_sequence_eleIdLoose_ptJ_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_ptJ_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_ptJ_") + names[i]).c_str () ,  40, 0, 200) ;
          ...
          m_e_sequence_eleIdTight_ptE_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdTight_ptE_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdTight_ptE_") + names[i]).c_str () ,  40, 0, 200) ;
          ...
          m_e_sequence_resol_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_resol_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_resol_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_sequence_tkIso_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_tkIso_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_tkIso_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_sequence_hadIso_EMfrac_flav[i] = new TH1F ((m_baseName + std::string ("m_e_sequence_hadIso_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_hadIso_EMfrac_") + names[i]).c_str () , 40, 0, 200) ; 
          m_e_sequence_eleId_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleId_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleId_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_sequence_eleIdLoose_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdLoose_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdLoose_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
          m_e_sequence_eleIdTight_EMfrac_flav[i]  = new TH1F ((m_baseName + std::string ("m_e_sequence_eleIdTight_EMfrac_") + names[i]).c_str () , (m_baseName + std::string ("m_e_sequence_eleIdTight_EMfrac_") + names[i]).c_str () , 40, 0, 200) ;
        }
//    
