...
SimpleNtuple = cms.EDAnalyzer(
    ...
    EleLessPVTag = cms.InputTag("NotInDefaultReco"),
    #### tracks ####
    ...
    savePUSummaryInfo = cms.untracked.bool (False),
    saveEleLessPV = cms.untracked.bool (False),
    saveMuonLessPV = cms.untracked.bool (False),
