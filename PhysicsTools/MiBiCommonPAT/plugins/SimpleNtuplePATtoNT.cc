// -*- C++ -*-
//
// Package:    SimpleNtuplePATtoNT
// Class:      SimpleNtuplePATtoNT
// 
/**\class SimpleNtuplePATtoNT SimpleNtuplePATtoNT.cc Analysis/SimpleNtuplePATtoNT/src/SimpleNtuplePATtoNT.cc
...
#include "PhysicsTools/MiBiCommonPAT/plugins/SimpleNtuplePATtoNT.h"
...
SimpleNtuplePATtoNT::SimpleNtuplePATtoNT(const edm::ParameterSet& iConfig)
{
 //---- Out file ----
 edm::Service<TFileService> fs;
 outTree_ = fs -> make<TTree>("SimpleNtuplePATtoNT","SimpleNtuplePATtoNT"); 
 ...
 chCandsTag_= iConfig.getParameter<edm::InputTag>("chCandsTag");
 ...
 if(saveRho_)
 {
   ...
   NtupleFactory_ -> AddFloat("rho_isolation_noPU");
   NtupleFactory_ -> AddFloat("rho_jets_noPU");
 }
 ...
 if(saveEle_)
 {
   ...
   NtupleFactory_ -> AddFloat("electrons_etaSC");
   ...
   NtupleFactory_->AddInt("electrons_numberOfLostHits");
   NtupleFactory_->AddFloat("electrons_passVtxConvert");
   ...
   NtupleFactory_->AddFloat("electrons_dist_conv");
   NtupleFactory_->AddFloat("electrons_dcot_conv");

   // IP variables

  NtupleFactory_->AddFloat("electrons_tip");
  NtupleFactory_->AddFloat("electrons_dzPV");

  // isolation variables


  NtupleFactory_->AddFloat("electrons_ip2");
  NtupleFactory_->AddFloat("electrons_hcalFull");
  NtupleFactory_->AddFloat("electrons_rhoEl");

  NtupleFactory_->AddFloat("electrons_pfCharged");
  NtupleFactory_->AddFloat("electrons_pfPhoton");
  NtupleFactory_->AddFloat("electrons_pfNeutral");
  NtupleFactory_->AddFloat("electrons_rhoElNoPU");
 ...
 if(saveMu_)
 {
  ...
  // isolation variable
   NtupleFactory_->AddFloat("muons_rhoMu");
   NtupleFactory_->AddFloat("muons_pfCharged");
 ...
 if(saveMet_)
 {
   ...
   NtupleFactory_->Add4V("PFCandidate");        
 }
...
SimpleNtuplePATtoNT::~SimpleNtuplePATtoNT()
{
...
void SimpleNtuplePATtoNT::fillHLTInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
...
void SimpleNtuplePATtoNT::fillBSInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillBSInfo::end" << std::endl;
}
...
void SimpleNtuplePATtoNT::fillPVInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{ 
  //std::cout << "SimpleNtuplePATtoNT::fillPVInfo::begin" << std::endl;
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillPVInfo::end" << std::endl;
}
...
void SimpleNtuplePATtoNT::fillRhoInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  //std::cout << "SimpleNtuplePATtoNT::fillRhoInfo::begin" << std::endl;
  
  edm::Handle<double> rhoForIsolation;
  iEvent.getByLabel("kt6PFJetsForIso", "rho", rhoForIsolation);
  ...
  edm::Handle<double> rhoForIsolationNoPU;
  iEvent.getByLabel("kt6PFJetsForIsoNoPU", "rho", rhoForIsolationNoPU);
  
  edm::Handle<double> rhoNoPU;
  iEvent.getByLabel("kt6PFJetsNoPU", "rho", rhoNoPU);

  NtupleFactory_ -> FillFloat("rho_isolation_noPU", *(rhoForIsolationNoPU.product()));
  NtupleFactory_ -> FillFloat("rho_jets_noPU", *(rhoNoPU.product()));
 
 //std::cout << "SimpleNtuplePATtoNT::fillRhoInfo::end" << std::endl;
}
...
void SimpleNtuplePATtoNT::fillEleLessPVInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  //std::cout << "SimpleNtuplePATtoNT::fillEleLessPVInfo::begin" << std::endl;
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillEleLessPVInfo::end" << std::endl;
}
...
void SimpleNtuplePATtoNT::fillMuonLessPVInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  //std::cout << "SimpleNtuplePATtoNT::fillMuonLessPVInfo::begin" << std::endl;
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillMuonLessPVInfo::end" << std::endl;
}

///------------------------
///---- Tracks infos ----

void SimpleNtuplePATtoNT::fillTrackInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
...
void SimpleNtuplePATtoNT::fillTauInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillTauInfo" << std::endl;
...
void SimpleNtuplePATtoNT::fillMuInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillMuInfo" << std::endl;
...
void SimpleNtuplePATtoNT::fillEleInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillEleInfo" << std::endl;
 ...
 */
 ...
 edm::Handle<reco::VertexCollection> vertixes;
 iEvent.getByLabel(PVTag_,vertixes);

 reco::Vertex::Point pvPos = vertixes->front().position();
 ...
 for ( unsigned int i=0; i<electrons.size(); ++i )
 {
  ...
  NtupleFactory_ -> FillFloat("electrons_likelihood",(electron.userFloat("liklihoodID")));

  NtupleFactory_->FillFloat("electrons_dist_conv", electron.userFloat("convValueMapProd:dist"));
  NtupleFactory_->FillFloat("electrons_dcot_conv", electron.userFloat("convValueMapProd:dcot"));

/*
  std::cout << " lik = " << electron.userFloat("liklihoodID") ;
  std::cout << " lik = " << electron.userFloat(  NtupleFactory_ -> FillFloat("electrons_eSC",scRef->energy());"liklihoodID") ;
  std::cout << " lik = " << electron.userFloat("liklihoodID") ;
  std::cout << " lik = " << electron.userFloat("liklihoodID") ;
  std::cout << " lik = " << electron.userFloat("liklihoodID") ;
  std::cout << " lik = " << electron.userFloat("liklihoodID") ;
  std::cout << " lik = " << electron.userFloat("liklihoodID") ;
  std::cout << " lik = " << electron.userFloat("liklihoodID") << std::endl;
*/
  ...
  NtupleFactory_ -> FillFloat("electrons_dxy_BS", fabs(electron.gsfTrack()->dxy(BSPoint_)));
  NtupleFactory_ -> FillFloat("electrons_dz_BS", fabs(electron.gsfTrack()->dz(BSPoint_)));
  NtupleFactory_ -> FillFloat("electrons_dxy_PV", fabs(electron.gsfTrack()->dxy(pvPos)));
  NtupleFactory_ -> FillFloat("electrons_edxy_PV", fabs(electron.gsfTrack()->dxyError()));
  NtupleFactory_ -> FillFloat("electrons_dz_PV",  fabs(electron.gsfTrack()->dz(pvPos)));
  ...
  NtupleFactory_ -> FillFloat("electrons_etaSC",scRef->eta());  
  ...
  */
  ...
  NtupleFactory_->FillInt("electrons_numberOfLostHits",electron.gsfTrack()->trackerExpectedHitsInner().numberOfLostHits());
  NtupleFactory_->FillFloat("electrons_passVtxConvert",electron.userFloat("convValueMapProd:passVtxConvert"));
  ...
  // IP variables 
  NtupleFactory_->FillFloat("electrons_tip", electron.userFloat("tip"));
  NtupleFactory_->FillFloat("electrons_dzPV", electron.userFloat("dzPV"));


  // iso variables

  NtupleFactory_->FillFloat("electrons_ip2", electron.userFloat("ip2"));
  NtupleFactory_->FillFloat("electrons_hcalFull", electron.userFloat("hcalFull"));
  NtupleFactory_->FillFloat("electrons_rhoEl", electron.userFloat("rhoEl"));

  NtupleFactory_->FillFloat("electrons_pfCharged", electron.userFloat("pfCharged"));
  NtupleFactory_->FillFloat("electrons_pfPhoton", electron.userFloat("pfPhoton"));
  NtupleFactory_->FillFloat("electrons_pfNeutral", electron.userFloat("pfNeutral"));
  NtupleFactory_->FillFloat("electrons_rhoElNoPU", electron.userFloat("rhoElNoPU"));
...
void SimpleNtuplePATtoNT::fillPhotonInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillPhotonInfo" << std::endl;
...
void SimpleNtuplePATtoNT::fillJetInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  //std::cout << "SimpleNtuplePATtoNT::fillJetInfo::begin" << std::endl;
  ...
  if (jet.isPFJet()){
   ...
   NtupleFactory_ -> FillInt  ("jets_chargedHadronMultiplicity",jet.chargedHadronMultiplicity()); 
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillJetInfo::end" << std::endl;
}
...
///--------------------
///---- HCAL Noise ----
void SimpleNtuplePATtoNT::fillHCALNoiseInfo(const edm::Event & iEvent, const edm::EventSetup & iESetup)
{
  //std::cout << "SimpleNtuplePATtoNT::fillHCALNoiseInfo::begin" << std::endl;
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillHCALNoiseInfo::end" << std::endl;
}
...
void SimpleNtuplePATtoNT::fillMetInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillMetInfo" << std::endl;
 
  edm::Handle<edm::View<reco::MET> > MetHandle;
  iEvent.getByLabel(MetTag_,MetHandle);
  edm::View<reco::MET> Met = *MetHandle;
  
  edm::Handle<edm::View<reco::MET> > TCMetHandle;
  iEvent.getByLabel(TCMetTag_,TCMetHandle);
  edm::View<reco::MET> TCMet = *TCMetHandle;

  edm::Handle<edm::View<reco::MET> > PFMetHandle;
  iEvent.getByLabel(PFMetTag_,PFMetHandle);
  edm::View<reco::MET> PFMet = *PFMetHandle;
  ...
  */
  ...
  for(reco::CandidateCollection::const_iterator it= candsH->begin(); it!=candsH->end(); ++it)
   {
        NtupleFactory_->Fill4V("PFCandidate",it->p4());
    }
...
void SimpleNtuplePATtoNT::fillMCPtHatInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  //std::cout << "SimpleNtuplePATtoNT::fillPtHatInfo::begin" << std::endl; 
  ...
  //std::cout << "SimpleNtuplePATtoNT::fillPtHatInfo::end" << std::endl; 
}


void SimpleNtuplePATtoNT::fillMCHiggsInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillMCHiggsDecayInfo" << std::endl; 
...
void SimpleNtuplePATtoNT::fillMCZWInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillMCZWDecayInfo" << std::endl; 
...
void SimpleNtuplePATtoNT::fillMCTTBarInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillMCTTBarInfo" << std::endl;
...
void SimpleNtuplePATtoNT::fillMCPUInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
 //std::cout << "SimpleNtuplePATtoNT::fillMCPUInfo" << std::endl;
...
void SimpleNtuplePATtoNT::fillProcessIdInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  //std::cout << "SimpleNtuplePATtoNT::fillProcessIdInfo" << std::endl; 
...
void SimpleNtuplePATtoNT::fillPhotonsMotherInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup) 
{
  edm::Handle<reco::GenParticleCollection> genParticles;
  iEvent.getByLabel(MCtruthTag_, genParticles);
...
void SimpleNtuplePATtoNT::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
 ++eventNaiveId_;
...
///===================================
DEFINE_FWK_MODULE(SimpleNtuplePATtoNT) ;
