#ifndef SimpleNtuplePATtoNT_h
#define SimpleNtuplePATtoNT_h
...
class SimpleNtuplePATtoNT : public edm::EDAnalyzer {
 
 public:
  
  //! ctor
  explicit SimpleNtuplePATtoNT(const edm::ParameterSet&);
