...
// $Id: EcalCosmicsHists.h,v 1.11 2008/05/28 07:49:45 torimoto Exp $
//
//
...
class EcalCosmicsTree : public edm::EDAnalyzer {
   public:
      explicit EcalCosmicsTree(const edm::ParameterSet&);
      ~EcalCosmicsTree();
  ...
  struct EcalCosmicsAnalysisVariables
  {
    ...
    float cosmicClusterEnergyXtals[100][25];//
    float cosmicClusterLengthXtals[100][25];//
