...
DEFINE_FWK_MODULE(MuonAssociatorUpDown);
DEFINE_FWK_MODULE(MuonAssociatorEcalIP);
//DEFINE_FWK_MODULE(EcalCosmicsTree);
DEFINE_FWK_MODULE(EcalCosmicsTreeTest);
DEFINE_FWK_MODULE(EcalCosmicsTreeXtals);
