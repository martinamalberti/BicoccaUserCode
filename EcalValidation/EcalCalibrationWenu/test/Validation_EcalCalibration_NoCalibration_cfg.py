...
process = cms.Process('EcalCalibration')
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/gwterax1/users/amassiro/CMSSWroot/Run2010B_Electron_RAW_RECO/669A4128-43D0-DF11-AE93-001A92810ACE.root')
)
...
process.GlobalTag.toGet = cms.VPSet(
    ...
    cms.PSet(record = cms.string("EBAlignmentRcd"),
             tag = cms.string("EBAlignment_measured_v02_offline"),
...
##################################################################################
##################################################################################
################## create ntuple for ECAL Calibration purposes ###################
...
process.patElectrons.electronSource = cms.InputTag("gsfElectrons::EcalCalibration")
...
process.ntupleEcalCalibration = cms.EDAnalyzer(
    'EcalCalibrationWenu',
...
process.TFileService = cms.Service(
    "TFileService",
    fileName = cms.string("EcalCalibration.root")
    )
...
process.pEcalCalibration = cms.Path(
...
process.schedule = cms.Schedule(
   ...
   process.pEcalCalibration        # | -> selections and ntuple
)
