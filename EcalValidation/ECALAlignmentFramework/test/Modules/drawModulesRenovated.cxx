void drawModulesRenovated(TString nameInFileRoot, TString nameOutputDir, TString nameDATA){
...
//   }
  ...
  ///~~~~ Dphi e+ ~~~~
  nameHistoInRootFile = Form("Data/%s_%d_7_Tot_temp",nameDATA.Data(),iSM+40);
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  h = (TH1F*) fileIn->Get(nameHistoInRootFile);
  if (iSM<18) {
   nameHistoInRootFile = Form ("Data/W_125_7_Tot_temp");  
  }
  else {
   nameHistoInRootFile = Form ("Data/W_126_7_Tot_temp");  
  }
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  hMC = (TH1F*) fileIn->Get(nameHistoInRootFile);
  cJoint->cd();
  h->Draw();
  norm = h->GetEntries(); hMC->DrawNormalized("HISTsame",norm);
  cJoint->SetGrid();
  ...
  ///~~~~ Dphi e- ~~~~
  nameHistoInRootFile = Form("Data/%s_%d_7_Tot_temp",nameDATA.Data(),iSM+80);
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  h = (TH1F*) fileIn->Get(nameHistoInRootFile);
  if (iSM<18) {
   nameHistoInRootFile = Form ("Data/W_129_7_Tot_temp");  
  }
  else {
   nameHistoInRootFile = Form ("Data/W_130_7_Tot_temp");  
  }
  hMC = (TH1F*) fileIn->Get(nameHistoInRootFile);
  cJoint->cd();
  h->Draw();
  ...
  ///~~~~ Deta ~~~~
  nameHistoInRootFile = Form("Data/%s_%d_6_Tot_temp",nameDATA.Data(),iSM);
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  h = (TH1F*) fileIn->Get(nameHistoInRootFile);
  if (iSM<18) {
   nameHistoInRootFile = Form ("Data/W_121_6_Tot_temp");  
  }
  else {
   nameHistoInRootFile = Form ("Data/W_122_6_Tot_temp");  
  }
  hMC = (TH1F*) fileIn->Get(nameHistoInRootFile);
  cJoint->cd();
  h->Draw();
 ...
 for (int iSM = 0; iSM <4; iSM++) {
  ///~~~~ Dphi e+ ~~~~
  nameHistoInRootFile = Form("Data/%s_%d_7_Tot_temp",nameDATA.Data(),iSM+40+36);
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  h = (TH1F*) fileIn->Get(nameHistoInRootFile);
  if (iSM<2) {
   nameHistoInRootFile = Form ("Data/W_124_7_Tot_temp");  
  }
  else {
   nameHistoInRootFile = Form ("Data/W_127_7_Tot_temp");  
  }
  hMC = (TH1F*) fileIn->Get(nameHistoInRootFile);
  cJoint->cd();
  h->Draw();
  ...
  ///~~~~ Dphi e- ~~~~
  nameHistoInRootFile = Form("Data/%s_%d_7_Tot_temp",nameDATA.Data(),iSM+80+36);
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  h = (TH1F*) fileIn->Get(nameHistoInRootFile);
  if (iSM<2) {
   nameHistoInRootFile = Form ("Data/W_128_7_Tot_temp");  
  }
  else {
   nameHistoInRootFile = Form ("Data/W_131_7_Tot_temp");  
  }
  hMC = (TH1F*) fileIn->Get(nameHistoInRootFile);
  cJoint->cd();
  h->Draw();
  ...
  ///~~~~ Deta ~~~~
  ///~~~~ Deta ~~~~
  nameHistoInRootFile = Form("Data/%s_%d_6_Tot_temp",nameDATA.Data(),iSM+36);
  std::cout << " Dphi e+ nameHistoInRootFile = " << nameHistoInRootFile.Data() << std::endl;
  h = (TH1F*) fileIn->Get(nameHistoInRootFile);
  if (iSM<2) {
   nameHistoInRootFile = Form ("Data/W_120_6_Tot_temp");  
  }
  else {
   nameHistoInRootFile = Form ("Data/W_123_6_Tot_temp");  
  }
  hMC = (TH1F*) fileIn->Get(nameHistoInRootFile);
  cJoint->cd();
  h->Draw();
